...
module Common
  module Client
    module Middleware
      module Request
        class MultipartAttachment < Faraday::Middleware
          include Rack::Mime
...
Faraday::Request.register_middleware multipart_attachment: Common::Client::Middleware::Request::MultipartAttachment
