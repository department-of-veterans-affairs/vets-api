...
FactoryBot.define do
  ...
  factory :dependent_verifications, class: Hash do
    ...
    trait :due_in_7_years do
      diaries { build_list(:diary_entry, 1, diary_due_date: Time.zone.now + 7.years) }
    end

    trait :due_in_7_years_1_day do
      diaries { build_list(:diary_entry, 1, diary_due_date: Time.zone.now + 7.years + 1.day) }
    end
  ...
  factory :diary_entry, class: Hash do
    ...
    diary_due_date { Time.zone.now + 6.years }
