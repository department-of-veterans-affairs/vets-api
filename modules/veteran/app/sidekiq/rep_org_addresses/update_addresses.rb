...
module RepOrgAddresses
  ...
  class UpdateAddresses
    ...
    def build_record_attributes(address, geocode, meta)
      # The address validation service response does not include county name and code for some records.
      county_name = address['county'].nil? ? nil : address['county']['name']
      county_code = address['county'].nil? ? nil : address['county']['county_fips_code']
