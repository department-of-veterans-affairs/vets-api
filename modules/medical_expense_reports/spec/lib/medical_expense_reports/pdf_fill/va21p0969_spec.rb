...
def basic_class
  MedicalExpenseReports::PdfFill::Va21p8416.new({})
end
...
describe MedicalExpenseReports::PdfFill::Va21p8416, skip: 'TODO after schema built' do
  ...
  context "with #{test_data_types.join(', ')}" do
    it_behaves_like 'a form filler', {
      ...
      factory: :medical_expense_reports_claim,
      use_vets_json_schema: true,
      input_data_fixture_dir: "modules/medical_expense_reports/spec/fixtures/pdf_fill/#{MedicalExpenseReports::FORM_ID}",
      output_pdf_fixture_dir: "modules/medical_expense_reports/spec/fixtures/pdf_fill/#{MedicalExpenseReports::FORM_ID}",
      test_data_types:,
    ...
    it 'merges the right fields' do
      Timecop.freeze(Time.zone.parse('2016-12-31 00:00:00 EDT')) do
        expected = get_fixture_absolute(
          'modules/medical_expense_reports/spec/fixtures/pdf_fill/21P-8416/merge_fields'
        )
