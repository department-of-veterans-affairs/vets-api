class CreateMHVMetricsUniqueUserEvents < ActiveRecord::Migration[7.2]
  def change
    create_table :mhv_metrics_unique_user_events, if_not_exists: true, id: false do |t|
      ...
      t.timestamp :created_at, null: false, default: -> { 'CURRENT_TIMESTAMP' }, comment: 'Auto-populated creation timestamp'
    end
  end
end
