...
module SimpleFormsApi
  module NotificationEmail
    class NotificationEmail
      attr_reader :template_ids, :form_number, :confirmation_number, :date_submitted, :expiration_date,
                  :lighthouse_updated_at, :notification_type, :user, :user_account, :form_data

      def initialize(config, notification_type: 'confirmation', user: nil, user_account: nil)
        filepath = 'modules/simple_forms_api/app/services/simple_forms_api/notification_email/template_ids.yml'
      ...
      def check_if_form_is_supported(config)
        unless @template_ids.keys.include?(config[:form_number])
          StatsD.increment('silent_failure', tags: statsd_tags) if error_notification?
