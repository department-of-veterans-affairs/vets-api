...
module Organizations
  class Names
    ORGS = [
      ...
      { poa: '64', name: 'National Association of County Veterans Service Of' },
      ...
      { poa: '96', name: 'United Spanish War Veterans * NOT ACCEPTING NEW CL' },
      { poa: '90', name: 'United Spinal Association' },
      { poa: '63', name: '--- V-A-F-     *no longer recognized*' },
      { poa: '97', name: 'Veterans of Foreign Wars' },
      { poa: '4R4', name: 'Veterans of the Vietnam War, Inc. & the Veterans C' },
      { poa: '98', name: 'Veterans of WW I of the USA, Inc.* NOT ACCEPTING N' },
      ...
      { poa: '4R1', name: 'Commonwealth of the Northern Mariana Islands Divis' },
      ...
      { poa: '9', name: 'New Jersey Department of Military and Veterans Aff' },
      ...
      { poa: '10', name: 'Pennsylvania Department of Military and Veterans A' },
      ...
      { poa: '4R2', name: 'Office of Veterans Affairs American Samoa Governme' },
