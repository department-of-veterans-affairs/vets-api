...
module AsyncTransaction
  module VAProfile
    class Base < AsyncTransaction::Base
      ...
      #
      # @param user [User] The user associated with the transaction
      # @param response [VAProfile::ContactInformation::V1::TransactionResponse] An instance of
      #   a VAProfile::ContactInformation::V1::TransactionResponse class, be it Email, Address, etc.
      # @return [AsyncTransaction::VAProfile::Base] A AsyncTransaction::VAProfile::Base record,
      #   be it Email, Address, etc.
      #
      ...
      # @param service [VAProfile::ContactInformation::V1::Service] an initialized VAProfile client
