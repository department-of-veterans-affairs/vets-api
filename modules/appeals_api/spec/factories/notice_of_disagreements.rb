...
FactoryBot.define do
  ...
  factory :min_nod_v2_issues_long_disagreement_area, class: 'AppealsApi::NoticeOfDisagreement' do
    id { SecureRandom.uuid }
    api_version { 'V2' }
    auth_headers { FixtureHelpers.fixture_as_json 'decision_reviews/v2/valid_10182_headers.json' }
    form_data { FixtureHelpers.fixture_as_json 'decision_reviews/v2/valid_10182_min_long_issues_area.json' }
  end
