    ...
    it 'should merge the right fields' do
      expect(described_class.new(form_data).merge_fields).to eq(
        {"veteranFullName"=>"john middle smith Sr.",
         ...
         "children" => [{"childFullName"=>"Mark1 Olson", "childPlaceOfBirth"=>"place1", "attendingCollege"=>true, "married"=>true, "biological"=>true, "stepchild"=>true, "disabled"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil}, {"childFullName"=>"Mark2 Olson", "childPlaceOfBirth"=>"place2", "attendingCollege"=>true, "married"=>true, "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil}, {"childFullName"=>"Mark3 Olson", "childPlaceOfBirth"=>"place3", "attendingCollege"=>true, "married"=>true, "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil}],
         "genderMale"=>true,
         "genderFemale"=>false,
