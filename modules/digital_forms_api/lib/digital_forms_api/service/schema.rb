...
module DigitalFormsApi
  module Service
    ...
    class Schema < Base
      ...
      # We set for an hour because schemas are not expected to change often
      # but this allows for updates to be picked up within a reasonable timeframe
      # without requiring a manual cache clear or deploy to reset the cache.
      CACHE_TTL = 1.hour
