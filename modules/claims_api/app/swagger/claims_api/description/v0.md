...
Internal VA users authenticate using an [API key](https://developer.va.gov/apply) issued at the organizational level. This authentication model is not supported in the external-only version of this API.
