...
module EmploymentQuestionnaires
  ...
  class Monitor < ::Logging::BaseMonitor
    # statsd key for api
    CLAIM_STATS_KEY = 'api.employment_questionnaires'
    # statsd key for sidekiq
    SUBMISSION_STATS_KEY = 'worker.lighthouse.employment_questionnaires_intake_job'

    attr_reader :tags

    def initialize
      super('employment-questionnaires')
    ...
    # @return [String]
    def form_id
      EmploymentQuestionnaires::FORM_ID
    end
  end
end
