...
module VIC
  class Service < Common::Client::Base
    ...
    SALESFORCE_USERNAME = 'vetsgov-devops-ci-feedback@listserv.gsa.gov.uat'
    ...
    def claim_set
      {
        iss: '3MVG9ic.6IFhNpPqk9eQOD7CSctHnhDcdnSRWffBdTtCMxY.eHhw1kxxP.eGAikTeJUBAbMCbuehW9fPlFDEA',
