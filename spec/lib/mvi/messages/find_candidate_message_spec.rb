  ...
  describe '.build' do
    ...
    context 'a missing argument' do
      it 'should throw an argument error' do
        expect do
          MVI::Messages::FindCandidateMessage.new.build('John', 'Smith', Time.new(1980, 1, 1).utc)
    ...
    context 'with an invalid date' do
      it 'should throw an argument error' do
        expect do
          MVI::Messages::FindCandidateMessage.new.build('John', 'Smith', '19800101', '555-44-3333')
    ...
    context 'with invalid name args' do
      it 'should throw an argument error' do
        expect do
          MVI::Messages::FindCandidateMessage.new.build(:John, 5, Time.new(1980, 1, 1).utc, '555-44-3333')
    ...
    context 'with an invalid ssn' do
      it 'should throw an argument error' do
        expect do
          MVI::Messages::FindCandidateMessage.new.build('John', 'Smith', Time.new(1980, 1, 1).utc, '555-4-3333')
