...
DOC_TYPE_ALLOWLIST = ClaimStatusTool::ClaimLetterDownloader::DOC_TYPE_ALLOWLIST
DOC_ID = '{99DA7758-A10A-43F4-A056-C961C76A2DDF}'

module ClaimStatusTool
  describe ClaimLetterDownloader do
    let(:current_user) do
      create(:evss_user)
    end
