...
module AppealsApi
  class EvidenceSubmissionSerializer
    ...
    attribute :final_status, if: proc { |_, _|
      # The final_status will be serialized only if the :sc_and_hlr_evidence_final_status_field flag is enabled
      Flipper.enabled?(:sc_and_hlr_evidence_final_status_field)
    } do |object, _|
