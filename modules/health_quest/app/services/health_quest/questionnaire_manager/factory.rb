  ...
  module QuestionnaireManager
    ...
    class Factory
      ...
      def initialize(user)
        ...
        @patient_service = HealthQuest::FHIR::Factory.manufacture(patient_type)
        @questionnaire_service = HealthQuest::FHIR::Factory.manufacture(questionnaire_type)
        @questionnaire_response_service = HealthQuest::FHIR::Factory.manufacture(questionnaire_response_type)
        @request_threads = []
