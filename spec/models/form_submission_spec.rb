...
RSpec.describe FormSubmission, type: :model do
  ...
  describe 'validations' do
    ...
    #   it { is_expected.to define_enum_for(:form_type).with_values(:form526, :form686) }
    it { is_expected.to define_enum_for(:form_type).with_values(described_class.form_types.keys) }
