...
module SurvivorsBenefits
  ...
  class Monitor < ::Logging::BaseMonitor
    # statsd key for api
    CLAIM_STATS_KEY = 'api.survivors_benefits'
    # statsd key for sidekiq
    SUBMISSION_STATS_KEY = 'worker.lighthouse.survivors_benefits_intake_job'

    attr_reader :tags

    def initialize
      super('survivors-benefits')
