...
describe Kafka::AvroProducer do
  ...
  let(:topic_payload_value) do
    "\x00\x00\x00\x00\x07\x00\n12345\x00\x02\x12ICN123456" \
    "\x12VASI98765\x00\x00\x00\x00\x10received(2024-03-04T12:00:00Z\x00\x00".b
  end
  ...
  describe 'validate payload' do
    ...
    it 'validates the payload against the schema' do
      VCR.use_cassette('kafka/topics') do
        ...
        topic_3_messages = avro_producer.producer.client.messages_for('submission_trace_form_status_change')
