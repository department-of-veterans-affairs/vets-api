  ...
  module Forms
    class Va221919 < FormBase
      ...
      def merge_fields(_)
        ...
        process_certifying_official(form_data)
        convert_boolean_fields(form_data)
        process_proprietary_conflicts(form_data)
        process_all_proprietary_conflicts(form_data)
