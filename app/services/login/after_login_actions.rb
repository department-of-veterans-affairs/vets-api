...
module Login
  class AfterLoginActions
    ...
    def perform
      ...
      if Flipper.enabled?(:mhv_medical_records_phr_refresh_on_login,
                          @current_user) && current_user.mhv_correlation_id.present?
        MHV::PhrUpdateJob.perform_async(current_user.icn,
