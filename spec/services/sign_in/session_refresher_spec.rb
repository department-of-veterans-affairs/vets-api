...
RSpec.describe SignIn::SessionRefresher do
  ...
  describe '#perform' do
    ...
    context 'given a refresh token and anti csrf token' do
      ...
      context 'when anti csrf token matches value in refresh token' do
        context 'and session handle in refresh token matches an existing oauth session' do
        ...
        context 'and session handle in refresh token does not match an existing oauth session' do
      ...
      context 'when anti csrf token does not match value in refresh token' do
