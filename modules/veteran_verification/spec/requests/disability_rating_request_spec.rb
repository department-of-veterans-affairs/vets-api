      ...
      with_settings(
        ...
        with_okta_configured do
          VCR.use_cassette('evss/disability_compensation_form/rated_disabilities') do
            ...
            key_file = File.read("#{VeteranVerification::Engine.root}/spec/fixtures/verification_test.pub")
            ...
            # Otherwise, it just returns the fake JWT hash in a let in from this file.
