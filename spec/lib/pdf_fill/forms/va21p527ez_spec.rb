    ...
    it 'should merge the right fields' do
      expect(described_class.new(form_data).merge_fields).to eq(
        {"veteranFullName"=>"john middle smith Sr.",
         ...
         "gender"=>"M",
         "marriages" => [{"spouseFullName"=>"Mark1 Olson", "locationOfSeparation"=>"location1", "marriageType"=>"type1", "reasonForSeparation"=>"divorce1"}, {"spouseFullName"=>"Mark2 Olson", "locationOfSeparation"=>"location2", "marriageType"=>"type2", "reasonForSeparation"=>"divorce2"}],
