...
RSpec.describe ClaimsEvidenceApi::Validation do
  ...
  describe '#validate_upload_payload' do
    it 'returns a valid upload payload hash' do
      expected = { contentName: 'foo.bar',
                   providerData: { contentSource:, dateVaReceivedDocument: '1955-11-05', documentTypeId: 23 } }
    ...
    context 'with bad data' do
      it 'checks contentName is a filename with extension' do
        provider_data = { contentSource:, dateVaReceivedDocument: '1955-11-05', documentTypeId: 23 }
      ...
      it 'checks required fields' do
        missing_required = { contentSource: }
      ...
      it 'checks field data types' do
        ...
        invalid_doctypeid = { contentSource:, dateVaReceivedDocument: '1955-11-05', documentTypeId: '23' }
      ...
      it 'checks field formats' do
        ...
        invalid_dateformat = { contentSource:, dateVaReceivedDocument: '11-05-1955', documentTypeId: 23 }
  ...
  describe '#validate_provider_data' do
    it 'returns a valid provider data hash' do
      valid = { contentSource:, dateVaReceivedDocument: '1955-11-05', documentTypeId: 23 }
