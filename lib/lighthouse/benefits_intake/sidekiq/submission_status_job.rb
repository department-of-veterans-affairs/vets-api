...
module BenefitsIntake
  class SubmissionStatusJob
    ...
    def perform(form_id = nil)
      ...
      pending_attempts = Lighthouse::SubmissionAttempt.where(status: 'pending').includes(:submission).to_a
      ...
      pending_attempts.select! { |pa| form_ids.include?(pa.submission.form_id) }
