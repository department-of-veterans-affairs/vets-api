...
module Lighthouse
  module PCIUAddress
    ##
    # HTTP client configuration for the {Lighthouse::PCIUAddress::Service},
    # sets the base path and a service name for breakers and metrics.
    #
    class Configuration < Lighthouse::Configuration
      self.read_timeout = Settings.lighthouse.pciu_address.timeout || 30
      ...
      #
      def mock_enabled?
        Settings.lighthouse.mock_pciu_address || false
      end
    end
  end
end
