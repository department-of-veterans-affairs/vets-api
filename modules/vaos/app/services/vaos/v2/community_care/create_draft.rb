...
module VAOS
  module V2
    module CommunityCare
      ##
      # CreateDraft - Command object for creating Community Care appointment drafts
      #
      ...
      #
      # @example Basic usage
      #   draft = CreateDraft.call(current_user, referral_id, referral_consult_id)
      #   if draft.error
      ...
      class CreateDraft
        ...
        # @return [CreateDraft] Instance with populated attributes or error
        ...
        #
        # @return [CreateDraft] self with populated attributes or error
        def call
        ...
        def validate_referral_not_used(referral_id)
          check = community_care_coordinator.referral_already_used?(referral_id)
          if check[:error]
        ...
        def log_npi_selection(selected_npi, npi_source, referral)
          ...
          log_data = {
            ...
            referring_npi_flag_enabled: Flipper.enabled?(:va_online_scheduling_use_referring_provider_npi,
                                                         @current_user),
