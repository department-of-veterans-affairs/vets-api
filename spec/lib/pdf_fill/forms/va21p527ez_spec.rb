    ...
    it 'should merge the right fields' do
      expect(described_class.new(form_data).merge_fields).to eq(
        {"veteranFullName"=>"john middle smith Sr.",
         ...
         "gender"=>"M",
         "children" => [{"childFullName"=>"Mark1 Olson", "biological"=>true, "stepchild"=>true, "disabled"=>true, "adopted"=>true, "previouslyMarried"=>true}, {"childFullName"=>"Mark2 Olson", "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true}, {"childFullName"=>"Mark3 Olson", "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true}],
         "genderMale"=>true,
         "genderFemale"=>false,
