...
RSpec.describe 'Form 21-4192 API', openapi_spec: 'public/openapi.json', type: :request do
  before(:all) do
    ...
    # Enable OpenAPI feature flag for tests
    Flipper.enable(:openapi_docs)
  end

  after(:all) do
    ActionController::Base.allow_forgery_protection = @original_allow_forgery_protection
    Flipper.disable(:openapi_docs)
  end

  before do
    # Set proper host to avoid ActionDispatch::HostAuthorization blocking
  ...
  path '/v0/form214192' do
    post 'Submit a 21-4192 form' do
      ...
      # Invalid SSN - letters
      response '400', 'Bad Request - Invalid SSN with letters' do
        schema type: :object,
               properties: {
                 errors: {
                   type: :array,
      ...
      # Invalid SSN - wrong length
      response '400', 'Bad Request - Invalid SSN length' do
        schema type: :object,
               properties: {
                 errors: {
                   type: :array,
      ...
      # Invalid email
      response '400', 'Bad Request - Invalid email address' do
        schema type: :object,
               properties: {
                 errors: {
                   type: :array,
      ...
      response '400', 'Bad Request - Missing required field' do
        schema type: :object,
               properties: {
                 errors: {
                   type: :array,
