      ...
      class Structure
        ...
        def form_fill
          options = {
            ...
            form_fields.birth_month => form_data.veteran_birth_month,
            form_fields.birth_day => form_data.veteran_birth_day,
            form_fields.birth_year => form_data.veteran_birth_year,
