  ...
  module ContactInformation
    module V1
      class Service < VAProfile::Service
        ...
        # @return [VAProfile::ContactInformation::V1::PersonResponse] response wrapper around an person object
        def get_person
          with_monitoring do
            vet360_id_present!
        ...
        # @return [VAProfile::ContactInformation::V1::AddressTransactionResponse] response wrapper around
        ...
        # @return [VAProfile::ContactInformation::V1::AddressTransactionResponse] response wrapper around a transaction object
        ...
        # @return [VAProfile::ContactInformation::V1::EmailTransactionResponse] response wrapper around a transaction object
        ...
        # @return [VAProfile::ContactInformation::V1::EmailTransactionResponse] response wrapper around an transaction object
        ...
        # @return [VAProfile::ContactInformation::V1::TelephoneUpdateResponse] response wrapper around a transaction object
        ...
        # @param transaction_id [int] the transaction_id to check
        # @return [VAProfile::ContactInformation::V1::TelephoneTransactionResponse] response wrapper around
        ...
        # @return [VAProfile::ContactInformation::V1::PermissionUpdateResponse] response wrapper around a transaction object
        ...
        # @param transaction_id [int] the transaction_id to check
        # @return [VAProfile::ContactInformation::V1::PermissionTransactionResponse] response wrapper around
        #   a transaction object
