    ...
    context 'when inflection header provided' do
      it 'returns a success' do
        ...
        expect(metrics.collect(&:source)).to include(
          ...
          'worker.lighthouse.form212680_intake_job.begun:1|c|#service:form212680,' \
          'function:track_submission_begun,form_id:21-2680',
          'worker.lighthouse.form212680_intake_job.success:1|c|#service:form212680,' \
          'function:track_submission_success,form_id:21-2680',
