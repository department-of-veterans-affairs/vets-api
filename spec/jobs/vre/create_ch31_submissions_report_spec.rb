    ...
    describe '#create_csv_array' do
      it 'creates the right array' do
        ...
        expect(
          ...
          csv_array: [['Count', 'Regional Office', 'Claimant Name', 'Confirmation #', 'Date Application Received',
                       'Type of Form', 'Total'],
                      [1, 'PLACEHOLDER', 'Homer Simpson', vre_claim_1.confirmation_number, '2017-07-27 00:00:00 UTC',
                       vre_claim_1.form_id, 2],
                      [2, 'PLACEHOLDER', 'Homer Simpson', vre_claim_2.confirmation_number, '2017-07-27 00:00:00 UTC',
                       vre_claim_2.form_id, 2]]
        )
      end
    end
