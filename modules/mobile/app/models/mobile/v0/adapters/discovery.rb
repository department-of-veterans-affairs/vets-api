      ...
      class Discovery
        ...
        def generate_response(params)
          ...
          response = {
              ...
              oauth_base_url: get_env_specific_url(params[:environment], OAUTH_ENV_MAP),
              api_root_url: get_env_specific_url(params[:environment], API_ROOT_ENV_MAP)
          }
          Mobile::V0::Discovery.new(response)
        end
