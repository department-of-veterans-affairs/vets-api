...
module HealthQuest
  module V1
    ...
    #
    # The issue must first be wrapped in a HealthQuest::V1::OperationOutcome which is passed to the serializer.
    ...
    #   issue = Common::Exceptions::BackendServiceException.new('HealthQuest_502', source: 'Klass')
    #   operation_outcome = HealthQuest::V1::OperationOutcome.new(resource_type: resource_type, id: id, issue: issue)
    #   HealthQuest::V1::OperationOutcomeSerializer.new(operation_outcome).serialized_json
    class OperationOutcomeSerializer
      # Creates a new serializer instance
      # @param operation_outcome HealthQuest::V1::OperationOutcome an instance of a outcome model
      # @return HealthQuest::V1::OperationOutcomeSerializer the instance
