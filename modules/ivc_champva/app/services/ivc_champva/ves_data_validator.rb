...
module IvcChampva
    class VesDataValidator
      ...
      def self.validate_beneficiaries(request_body)
        ...
        unless beneficiaries.is_a?(Array)
          raise ArgumentError, 'beneficiaries is invalid. Must be an array'
        end
      ...
      def self.validate_uuid_length(uuid, name)
        ...
        unless uuid.length == 36
          raise ArgumentError, "#{name} is invalid. Must be 36 characters"
        end
      end
