...
RSpec.describe BEP::DependencyVerificationService do
  ...
  describe '#read_diaries' do
    ...
    it 'returns an empty response when it cannot find records' do
      VCR.use_cassette('bep/diaries_service/read_empty_diaries') do
