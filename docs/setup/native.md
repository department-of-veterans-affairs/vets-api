...
- Ruby 3.2.2
- PostgreSQL 14.x (including PostGIS 3.1)
- Redis 5.0.x
...
1. Install Postgresql & PostGIS
   ...
   - Download the Postgres.app with PostgreSQL 10, 11 , 12 and 14
   - Install Instructions here: https://postgresapp.com/
   - `sudo mkdir -p /etc/paths.d && echo /Applications/Postgres.app/Contents/Versions/latest/bin | sudo tee /etc/paths.d/postgresapp`
   - `ARCHFLAGS="-arch x86_64" gem install pg -v 1.2.3`
   2. Alternatively Postgresql 14 & PostGIS 3.1 can be installed with homebrew
