...
describe 'Intent to file', openapi_spec: 'modules/claims_api/app/swagger/claims_api/v1/swagger.json' do # rubocop:disable RSpec/DescribeClass
  path '/forms/0966' do
      ...
      describe 'Getting a successful response' do
        response '200', '0966 Response' do
          ...
          before do |example|
            ...
            mock_acg(scopes) do
              VCR.use_cassette('claims_api/bgs/intent_to_file_web_service/insert_intent_to_file', erb: true) do
                submit_request(example.metadata)
              end
            end
          end
      ...
      describe 'Getting a 200 response' do
        response '200', '0966 response' do
          ...
          before do |example|
            ...
            mock_acg(scopes) do
              VCR.use_cassette('claims_api/bgs/intent_to_file_web_service/get_intent_to_file', erb: true) do
                submit_request(example.metadata)
              end
            end
          end
