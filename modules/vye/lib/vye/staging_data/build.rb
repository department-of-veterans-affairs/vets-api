  ...
  module StagingData
    class Build
      ...
      def dump
        ...
        streams do |test_users:, mvi_staging_users:|
      ...
      attr_reader :source, :target, :test_users, :mvi_staging_users
      ...
      def streams
        test_users = paths[:test_users].open('r')
        mvi_staging_users = paths[:mvi_staging_users].open('r')

        yield(test_users:, mvi_staging_users:)
      ensure
        mvi_staging_users.close
        test_users.close
      end
