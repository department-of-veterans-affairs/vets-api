...
RSpec.describe 'Messages Integration', type: :request do
  ...
  describe '#index' do
    ...
    #   VCR.use_cassette("sm/messages/#{user_id}/index") do
    #     get '/v0/messaging/health/folders/0/messages?filter[[id][eq]]=573302'
    #
    #     expect(response).to match_response_schema('messages_filtered')
    #     data = JSON.parse(response.body)['data']
    #
    #     expect(data.length).to eq(1)
    #     expect(data.first['id']).to eq('573302')
    #   end
    # end
  end
