...
RUN curl -L https://codeclimate.com/downloads/test-reporter/test-reporter-latest-linux-amd64 > /src/vets-api/cc-test-reporter
RUN chmod +x /src/vets-api/cc-test-reporter
