...
RSpec.describe BGSDependents::ChildSchool do
  ...
  let(:formatted_params_result_v2_b) do
    {
      vnp_proc_id: '3829729',
      vnp_ptcpnt_id: '149471',
      last_term_start_dt: DateTime.parse('2024-01-01 12:00:00').to_time.iso8601,
  ...
  describe '#params for 686c where there is no type_of_program_or_benefit included in the payload' do
    it 'formats child school params for submission' do
      formatted_info = child_school_info_v2_b.params_for_686c
      expect(formatted_info).to include(formatted_params_result_v2_b)
    end
  end
end
