FactoryBot.define do
  factory :notification, class: "VANotify::Notification" do
    ...
    reference { nil }
    to { "email@email.com" }
    status { %w[temporary-failure permanent-failure technical-failure preferences-declined pending pending-virus-check virus-scan-failed validation-failed failed created sending delivered sent].sample }
