...
describe AppealsApi::Appellant, type: :model do
  ...
  shared_examples 'appellant attributes' do |opts|
    let(:auth_headers) { fixture_as_json opts[:auth_headers] }
    let(:form_data) { fixture_as_json opts[:form_data] }
  ...
  include_examples 'appellant attributes',
                   auth_headers: 'decision_reviews/v2/valid_200996_headers_extra.json',
                   form_data: 'decision_reviews/v2/valid_200996_extra.json'

  include_examples 'appellant attributes',
                   auth_headers: 'higher_level_reviews/v0/valid_200996_headers.json',
                   form_data: 'higher_level_reviews/v0/valid_200996_extra.json'
end
