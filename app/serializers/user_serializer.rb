...
class UserSerializer < ActiveModel::Serializer
  ...
  def services
    ...
    services += [BackendServices::RX, BackendServices::MESSAGING] if object.can_access_mhv?
    services << BackendServices::DISABILITY_BENEFITS if object.can_access_evss?
    services << BackendServices::USER_PROFILE if object.can_access_user_profile?
  end
end
