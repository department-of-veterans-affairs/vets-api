...
RSpec.describe 'Find a Rep - Other Representatives spec', type: :request do
  context 'when find a rep is disabled' do
    ...
    it 'returns a not found routing error' do
      get '/services/veteran/v0/other_accredited_representatives'
  ...
  context 'when find a rep is enabled' do
    ...
    context 'when a required param is missing' do
      it 'returns a bad request error' do
        get '/services/veteran/v0/other_accredited_representatives', params: { type: 'organization', lat: 39 }
    ...
    context 'when the type param is invalid' do
      it 'returns a bad request error' do
        get '/services/veteran/v0/other_accredited_representatives', params: { type: 'abc', lat: 39, long: -75 }
