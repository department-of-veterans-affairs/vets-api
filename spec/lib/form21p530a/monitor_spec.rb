...
RSpec.describe Form21p530a::Monitor do
  ...
  describe '#track_submission_begun (comprehensive)' do
    let(:claim) { SavedClaim::Form21p530a.new(form: '{}', guid: SecureRandom.uuid) }
  ...
  describe '#track_submission_success (comprehensive)' do
    let(:claim) { SavedClaim::Form21p530a.new(form: '{}', guid: SecureRandom.uuid) }
  ...
  describe '#track_submission_failure (comprehensive)' do
    let(:claim) { SavedClaim::Form21p530a.new(form: '{}', guid: SecureRandom.uuid) }
  ...
  describe '#track_request_code (comprehensive)' do
    it 'increments StatsD metric' do
