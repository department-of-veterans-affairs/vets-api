  ...
  module Appenders
    class AuditLogAppender < Base
      ...
      def subject_user_identifier
        identifier_for(subject_user_account, subject_user_verification)
      end

      def subject_user_identifier_type
        identifier_type_for(subject_user_account, subject_user_verification)
      end

      def acting_user_identifier
        if acting_user_verification_id == subject_user_verification_id
          subject_user_identifier
        else
      ...
      def acting_user_verification
        @acting_user_verification ||= UserVerification.find(acting_user_verification_id)
      end
      ...
      def subject_user_verification
        @subject_user_verification ||= UserVerification.find(subject_user_verification_id)
      end
