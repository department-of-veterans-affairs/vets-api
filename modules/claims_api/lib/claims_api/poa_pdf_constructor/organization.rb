    ...
    class Organization < ClaimsApi::PoaPdfConstructor::Base
      ...
      def page1_options(data)
        base_form = 'F[0].Page_1[0]'
        {
          ...
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[1]": get_zip_code_first_five(data, 'veteran'),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_LastFourNumbers[1]": get_zip_code_last_four(data, 'veteran'),
          ...
          "#{base_form}.Claimants_MailingAddress_NumberAndStreet[0]": get_street_address(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_ApartmentOrUnitNumber[0]": get_unit_or_apartment(data, 'claimant'),
          ...
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[0]": get_zip_code_first_five(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_LastFourNumbers[0]": get_zip_code_last_four(data, 'claimant'),
