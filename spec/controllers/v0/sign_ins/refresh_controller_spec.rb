...
RSpec.describe V0::SignIns::RefreshController, type: :controller do
  describe 'POST refresh' do
    ...
    shared_examples 'error response' do
      ...
      let(:expected_error_log) { '[SignInService] [V0::SignIns::RefreshController] refresh error' }
    ...
    context 'when refresh_token is the proper encrypted refresh token format' do
      ...
      let(:expected_log_message) { '[SignInService] [V0::SignIns::RefreshController] refresh' }
