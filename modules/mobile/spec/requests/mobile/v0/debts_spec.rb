    ...
    { "type" => "debts",
      "attributes" =>
        { "fileNumber" => "796043735",
          ...
          "currentAr" => 123.34,
          "debtHistory" =>
            [{ "date" => "09/12/1998", "letterCode" => "123", "description" => "Third Demand Letter - Potential Treasury Referral" },
             { "date" => "09/13/1997", "letterCode" => "123", "description" => "Third Demand Letter - Potential Treasury Referral" },
             { "date" => "04/01/1997", "letterCode" => "122", "description" => "Referall To Credit Reporting Agencies (CRA)" },
             { "date" => "09/14/1996", "letterCode" => "123", "description" => "Third Demand Letter - Potential Treasury Referral" },
             { "date" => "09/16/1995", "letterCode" => "123", "description" => "Third Demand Letter - Potential Treasury Referral" },
             { "date" => "04/04/1995", "letterCode" => "145", "description" => "Referall To Credit Alert Interactive Verification Reporting System (CAIVRS) In 30 Days" },
             { "date" => "02/14/1995", "letterCode" => "117", "description" => "Second Demand Letter - Potential Negative Referral" },
             { "date" => "11/15/1994", "letterCode" => "603", "description" => "Late Or Missed Payment Notification" },
             { "date" => "09/10/1994", "letterCode" => "123", "description" => "Third Demand Letter - Potential Treasury Referral" }] }
    }
  }
      ...
      "attributes" =>
        {
          ...
          "debtHistory" =>
            [{ "date" => "04/01/2017", "letterCode" => "608", "description" => "Full C&P Benefit Offset Notification" },
             ...
             { "date" => "03/26/2015", "letterCode" => "100", "description" => "First Demand Letter - Inactive Benefits - Due Process" }]
        }
    }
  }
      ...
      "attributes" =>
        {
          ...
          "debtHistory" =>
            [{ "date" => "08/08/2018", "letterCode" => "608", "description" => "Full C&P Benefit Offset Notification" },
             { "date" => "07/19/2018", "letterCode" => "100", "description" => "First Demand Letter - Inactive Benefits - Due Process" }]
        }
    }
  }
      ...
      it 'fetches the veterans debt data' do
        VCR.use_cassette('bgs/people_service/person_data') do
          VCR.use_cassette('debts/get_letters') do
            ...
            expect(debt_data).to include(debt_1)
            expect(debt_data).to include(debt_2)
            expect(debt_data).to include(debt_3)
            expect(debt_data).to include(debt_4)
            expect(debt_data).to include(debt_5)
          end
        end
      end
    end
