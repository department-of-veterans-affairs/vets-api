...
graph TD
    ...
    DB2 --> Enqueue[ClaimProcessor.enqueue_submissions]
    ...
    BackupService --> BackupSuccess[Mark Parent Group PROCESSING<br/>Send Submitted Notification]
...
4. **[Backup Job](./backup_job_flow.md)** - Lighthouse-only submission as last resort
   ...
   - Success: Mark parent group PROCESSING, send submitted notification
