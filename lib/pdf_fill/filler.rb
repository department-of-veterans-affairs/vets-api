...
module PdfFill
  module Filler
    ...
    def fill_form(saved_claim, file_name_extention = nil)
      form_id = saved_claim.form_id
      form_class = FORM_CLASSES[form_id]

      process_form(form_id, saved_claim.parsed_form, form_class, file_name_extention || saved_claim.id)
    end
    ...
    def process_form(form_id, form_data, form_class, file_name_extention)
      folder = 'tmp/pdfs'
      FileUtils.mkdir_p(folder)
      file_path = "#{folder}/#{form_id}_#{file_name_extention}.pdf"
