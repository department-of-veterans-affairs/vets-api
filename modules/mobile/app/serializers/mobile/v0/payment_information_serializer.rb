...
module Mobile
  module V0
    class PaymentInformationSerializer
      ...
      def initialize(user, payment_account, account_control, options = {})
        account_control = if Flipper.enabled?(:mobile_lighthouse_direct_deposit, user)
        ...
        resource = PaymentInformationStruct.new(user.uuid, payment_account.to_h, account_control)
