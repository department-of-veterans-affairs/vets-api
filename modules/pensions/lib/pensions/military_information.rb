...
module Pensions
  ...
  class MilitaryInformation < ::VAProfile::Prefill::MilitaryInformation
    ...
    ##
    # Returns the first uniformed service entry date from the service history
    #
    ...
    ##
    # Returns the last active discharge date from the service history
    #
    # @return [String] "YYYY-MM-DD"
    ...
    ##
    # Maps service episodes to their corresponding branch mappings
    #
    # @return [Array<String>]
    def map_service_episodes_to_branches
      service_history.episodes.map do |episode|
        ...
        MilitaryInformation::PENSION_SERVICE_BRANCHES_MAPPING[branch_value]
      end
    end
  end
end
