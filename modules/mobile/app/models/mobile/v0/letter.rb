...
module Mobile
  module V0
    class Letter < Common::Resource
      ...
      attribute :reference_number, Types::String.optional # only for COE home loan letters
      attribute :coe_status, Types::String.optional # only for COE home loan letters
