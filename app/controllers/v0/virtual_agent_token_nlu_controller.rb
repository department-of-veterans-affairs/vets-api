...
module V0
  ...
  class VirtualAgentTokenNluController < ApplicationController
    service_tag 'virtual-agent'
    skip_before_action :authenticate, only: [:create]

    rescue_from 'V0::VirtualAgentTokenNluController::ServiceException', with: :service_exception_handler
    ...
    def bearer_token
      secret = Settings.virtual_agent.webchat_secret_nlu
