...
Rspec.describe 'AppealsApi::V2::DecisionReviews::NoticeOfDisagreements', type: :request do
  ...
  describe '#download', skip: 'temporarily skipped' do
    it_behaves_like(
      ...
      described_class: AppealsApi::V2::DecisionReviews::NoticeOfDisagreementsController
    )
  end
