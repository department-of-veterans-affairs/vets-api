  ...
  it 'f' do
    ...
    {"application"=>
      {"accept_warnings"=>false,
       ...
       "created_date"=>1533683681962,
       "documents"=>[],
       "expiration_date"=>1565219681962,
       "has30_percent"=>true,
       "modified_date"=>1533683688429,
       "valid_user"=>true},
     "rbps"=>true,
