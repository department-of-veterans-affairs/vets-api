...
RSpec.describe SignIn::ServiceAccountAssertionValidator do
  describe '#perform' do
    subject do
      SignIn::ServiceAccountAssertionValidator.new(service_account_assertion:,
    ...
    context 'when service_account_assertion is a valid jwt' do
      ...
      context 'when service_account_assertion values pass validation' do
