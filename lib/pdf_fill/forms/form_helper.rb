module PdfFill
    module Forms
        class FormHelper
            ...
            def self.split_ssn(veteranSocialSecurityNumber) 
                return if veteranSocialSecurityNumber.blank?
        
                split_ssn = {
                    'first' => veteranSocialSecurityNumber[0..2],
                    'second' => veteranSocialSecurityNumber[3..4],
                    'third' => veteranSocialSecurityNumber[5..8]
                }
