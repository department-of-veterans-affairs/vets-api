...
RSpec.describe ClaimsApi::RevisedDisabilityCompensationValidations do
  ...
  describe '#validate_form_526_title10_anticipated_separation_date!' do
    ...
    # FES allows anticipatedSeparationDate to be the same as claimDate, so we allow here as well
    context 'when both anticipatedSeparationDate and claimDate are today' do
      let(:claim_date) { Time.zone.today.iso8601 }
