  ...
  let(:formatted_params_result) do
    {
      ...
      last_term_start_dt: Date.parse('2016-03-04').iso8601,
      last_term_end_dt: Date.parse('2017-04-05').iso8601,
      ...
      school_term_start_dt: Date.parse('2019-03-05').iso8601,
      gradtn_dt: Date.parse('2023-03-03').iso8601
    }
  end
