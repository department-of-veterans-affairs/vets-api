  ...
  describe '#create' do
    ...
    context 'when external service is healthy' do
      ...
      let(:recorded_token) do
        ...
        'am5HeUNMQmE5ODBWTE4wTW1ROCIsDQogICJ0eXAiOiAiSldUIg0KfQ.ew0KICAiYm90IjogImF6Y2N0b2xhYmhlYWx0aGJvdC1kamVvZXhjI' \
        'iwNCiAgInNpdGUiOiAiUHh4SzRLa083aVkiLA0KICAiY29udiI6ICJhR09FRG1QNVFjSVFET1ZKd1F1VXotZCIsDQogICJuYmYiOiAxNTg3M' \
        'DcwNTYwLA0KICAiZXhwIjogMTU4NzA3NDE2MCwNCiAgImlzcyI6ICJodHRwczovL2RpcmVjdGxpbmUuYm90ZnJhbWV3b3JrLmNvbS8iLA0KI' \
        'CAiYXVkIjogImh0dHBzOi8vZGlyZWN0bGluZS5ib3RmcmFtZXdvcmsuY29tLyINCn0.tCn9kTNI3YOwyk5SouVMuc9WlK60RMnOC-zn3g6zt' \
        'nX1E1IDNfd2GmhDZIDfgB4VUWKC-6pRYJPhjGQqYEHbhbOhAB3avvFr81i_A2KyFiYKF-KCsl-4ACGiet6tV7RUNfkeUtqnJEpB_-Z8cpB2T' \
