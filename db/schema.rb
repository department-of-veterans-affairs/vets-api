...
ActiveRecord::Schema[7.2].define(version: 2025_02_21_215147) do
  ...
  create_table "ar_power_of_attorney_request_notifications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.uuid "power_of_attorney_request_id", null: false
  ...
  add_foreign_key "ar_power_of_attorney_request_notifications", "va_notify_notifications", column: "notification_id"
