...
RSpec.describe 'VA and Community Care Mashup', type: :request, team: :facilities, vcr: vcr_options do
  ...
  { 'id' => '927d31eb-11fd-43c2-ac29-11c1a4128819',
    ...
    { 'providers' =>
      { 'data' =>
        [{ 'id' =>
           'b190bc4fc5a8f9e8633df1bef4fcdfa4081b40ba1c92e6151b31441e50f91dbb',
           'type' => 'provider' },
         { 'id' =>
           '58c6acd75b174903d6aae7284567f007962f1c3588ba98725018a1ca48e3054b',
           'type' => 'provider' },
         { 'id' =>
           '23b9ba9fd9c5b55d149163e1bf325a3eafe6b550f97987b6153cc485b8472265',
           'type' => 'provider' },
         { 'id' =>
           '021c84f43edddbe11cd5784f9d4fdfaab92ce5f24bbc8cc69e66e3bf3336073d',
           'type' => 'provider' },
         { 'id' =>
           'acb595132b8f22416153086a5ebdd7dfc6bd7da56965ac5d1a18374b3e1901a8',
           'type' => 'provider' },
         { 'id' =>
           'c8ea0e2d8f21a0628d3900d919c9933f3d0378f8ea19faefd70a77466054f70d',
           'type' => 'provider' },
         { 'id' =>
           '9d74be207e16b6e2dc26a94e944533b692c64a2ee7213c812471a4aa6adf7cb9',
           'type' => 'provider' },
         { 'id' =>
           'a64612810c102e0a6ff7b4099ecd50032c5be9e0a60004e166bcb61814628522',
           'type' => 'provider' },
         { 'id' =>
           '22f324d93d93eb39fce95c702a7967a2aa8a111a6f2b7973671c63431ef741b1',
           'type' => 'provider' },
         { 'id' =>
           'c4939eac9bea3d6bac7477b7228a632233f853851463169828d04c8580817b50',
           'type' => 'provider' }] },
      'facilities' =>
      { 'data' =>
        [{ 'id' => 'vha_561', 'type' => 'facility' },
         { 'id' => 'vha_620', 'type' => 'facility' },
         { 'id' => 'vha_620A4', 'type' => 'facility' },
         { 'id' => 'vha_689', 'type' => 'facility' },
         { 'id' => 'vha_542', 'type' => 'facility' },
         { 'id' => 'vha_689A4', 'type' => 'facility' }] } } },
            'included' =>
  [{ 'id' => 'vha_561',
     'type' => 'facility',
     'attributes' =>
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Audiology', 'new' => 49.823529, 'established' => 22.705882 },
          { 'service' => 'Cardiology',
            'new' => 17.736842,
            'established' => 14.652173 },
          { 'service' => 'Dermatology', 'new' => 4.185185, 'established' => 2.0 },
          ...
          { 'service' => 'Optometry', 'new' => 0.0, 'established' => 60.053763 },
          { 'service' => 'Orthopedics', 'new' => 5.130434, 'established' => 0.445945 },
          { 'service' => 'PrimaryCare', 'new' => 5.95, 'established' => 2.883495 },
          { 'service' => 'SpecialtyCare',
            'new' => 17.447457,
            'established' => 10.865472 },
          { 'service' => 'Urology', 'new' => 63.333333, 'established' => 0.6 }],
   ...
   { 'id' => 'vha_620',
     ...
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Cardiology', 'new' => 2.0, 'established' => 1.5 },
          { 'service' => 'MentalHealthCare', 'new' => 4.0, 'established' => 0.63 },
          { 'service' => 'Optometry', 'new' => 5.272727, 'established' => 1.448717 },
          { 'service' => 'PrimaryCare', 'new' => 3.09375, 'established' => 0.961904 },
          { 'service' => 'SpecialtyCare',
            'new' => 8.652173,
   ...
   { 'id' => 'vha_620A4',
     ...
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Audiology', 'new' => 5.066666, 'established' => 0.35 },
          { 'service' => 'Cardiology', 'new' => 9.764705, 'established' => 3.943925 },
          { 'service' => 'Dermatology',
            'new' => 28.833333,
            'established' => 11.771929 },
          { 'service' => 'Gastroenterology', 'new' => 5.6, 'established' => 11.34375 },
          { 'service' => 'Gynecology', 'new' => nil, 'established' => 4.666666 },
          { 'service' => 'MentalHealthCare', 'new' => 4.2, 'established' => 0.41 },
          { 'service' => 'Optometry', 'new' => 2.636363, 'established' => 0.252631 },
          { 'service' => 'PrimaryCare',
            'new' => 10.795918,
          ...
          { 'service' => 'Urology', 'new' => 13.954545, 'established' => 7.5 }],
         'effective_date' => '2020-07-27' },
       'active_status' => 'A',
       'address' =>
       { 'mailing' => {},
       ...
       'visn' => '2',
       'website' =>
       'https://www.hudsonvalley.va.gov/locations/Castle_Point_Campus.asp' } },
   { 'id' => 'vha_689',
     'type' => 'facility',
     'attributes' =>
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Audiology', 'new' => 11.121212, 'established' => 8.549295 },
          { 'service' => 'Cardiology', 'new' => 24.466666, 'established' => 7.717842 },
          { 'service' => 'Dermatology',
            'new' => 22.533333,
            'established' => 2.569892 },
          { 'service' => 'Gastroenterology', 'new' => 18.8, 'established' => 8.92 },
          { 'service' => 'Gynecology', 'new' => 7.142857, 'established' => 1.482758 },
          { 'service' => 'MentalHealthCare',
            'new' => 4.352941,
          ...
          { 'service' => 'Optometry', 'new' => 21.830188, 'established' => 5.345104 },
          { 'service' => 'Orthopedics',
            'new' => 16.818181,
            'established' => 8.085714 },
          { 'service' => 'PrimaryCare', 'new' => 4.55, 'established' => 3.487752 },
          { 'service' => 'SpecialtyCare',
            'new' => 17.755555,
            'established' => 8.987563 },
          { 'service' => 'Urology', 'new' => 16.023809, 'established' => 12.819819 },
          { 'service' => 'WomensHealth', 'new' => nil, 'established' => 0.784615 }],
         'effective_date' => '2020-07-27' },
       'active_status' => 'A',
       'address' =>
       { 'mailing' => {},
   ...
   { 'id' => 'vha_542',
     ...
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Audiology', 'new' => 16.25, 'established' => 1.083333 },
          { 'service' => 'Gynecology', 'new' => 83.333333, 'established' => 0.0 },
          { 'service' => 'MentalHealthCare',
            'new' => 7.90909,
            'established' => 2.996632 },
          { 'service' => 'Optometry', 'new' => 8.714285, 'established' => 6.458515 },
          { 'service' => 'Orthopedics', 'new' => 15.6, 'established' => 7.0 },
          { 'service' => 'PrimaryCare',
            'new' => 15.647058,
          ...
          { 'service' => 'Urology', 'new' => nil, 'established' => 0.0 }],
         'effective_date' => '2020-07-27' },
       'active_status' => 'A',
       'address' =>
       { 'mailing' => {},
   ...
   { 'id' => 'vha_689A4',
     ...
     { 'access' =>
       { 'health' =>
         [{ 'service' => 'Audiology', 'new' => 3.237288, 'established' => 1.447368 },
          { 'service' => 'Cardiology', 'new' => 20.0, 'established' => 12.163265 },
          { 'service' => 'Dermatology', 'new' => 5.15, 'established' => 8.788461 },
          { 'service' => 'Gynecology', 'new' => 15.25, 'established' => 14.0 },
          { 'service' => 'MentalHealthCare',
            'new' => 6.166666,
            'established' => 2.442307 },
          { 'service' => 'Ophthalmology', 'new' => 3.0, 'established' => 8.466666 },
          { 'service' => 'Optometry', 'new' => 6.727272, 'established' => 1.186256 },
          { 'service' => 'PrimaryCare', 'new' => 9.0, 'established' => 3.810309 },
          { 'service' => 'SpecialtyCare',
            'new' => 12.875846,
            'established' => 10.416932 },
          { 'service' => 'Urology', 'new' => 26.565217, 'established' => 14.492647 }],
         'effective_date' => '2020-07-27' },
       'active_status' => 'A',
       'address' =>
       { 'mailing' => {},
       ...
       'visn' => '1',
       'website' =>
       'https://www.connecticut.va.gov/locations/Newington_Campus.asp' } },
   { 'id' => 'b190bc4fc5a8f9e8633df1bef4fcdfa4081b40ba1c92e6151b31441e50f91dbb',
     ...
     'relationships' => { 'specialties' => { 'data' => [] } } },
