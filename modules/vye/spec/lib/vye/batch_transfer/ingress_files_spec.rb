...
RSpec.describe Vye::BatchTransfer::IngressFiles do
  ...
  describe 'imports lines from TIMS extract' do
    before do
      create(:vye_user_profile, ssn: '441972624', file_number: '227366592')
      create(:vye_user_profile, ssn: '596100167', file_number: '662929072')
      create(:vye_user_profile, ssn: '194889304', file_number: '301143261')
      create(:vye_user_profile, ssn: '261045161', file_number: '704243999')
      create(:vye_user_profile, ssn: '036662203', file_number: '690756310')
      create(:vye_user_profile, ssn: '942504788', file_number: '738416685')
      create(:vye_user_profile, ssn: '261077041', file_number: '823716203')
      create(:vye_user_profile, ssn: '970447691', file_number: '420365151')
      create(:vye_user_profile, ssn: '151014371', file_number: '948813522')
      create(:vye_user_profile, ssn: '807164639', file_number: '444442869')
      create(:vye_user_profile, ssn: '124496046', file_number: '114591317')
      create(:vye_user_profile, ssn: '045274951', file_number: '037619065')
      create(:vye_user_profile, ssn: '500042905', file_number: '732531728')
      create(:vye_user_profile, ssn: '333224444', file_number: '883200138')
      create(:vye_user_profile, ssn: '992549762', file_number: '333224444')
    end
