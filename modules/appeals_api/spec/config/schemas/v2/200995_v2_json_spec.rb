...
describe 'VA Form 20-0995 JSON Schema', type: :request do
  include SchemaHelpers
  include FixtureHelpers

  let(:json_schema) { read_schema '200995.json', 'decision_reviews', 'v2' }
  ...
  let(:json_appealable_issue) do
    fixture_as_json('decision_reviews/v2/valid_200995.json').tap do |payload|
