...
module ValueObjects
  class VnpBenefitClaim < Dry::Struct
    ...
    attribute :vnp_benefit_claim_id, Types::String
    attribute :vnp_benefit_claim_type_code, Types::String
    attribute :claim_jrsdtn_lctn_id, Types::String
    attribute :intake_jrsdtn_lctn_id, Types::String
    attribute :claim_received_date, Types::Nominal::DateTime
    attribute :program_type_code, Types::String
    attribute :participant_claimant_id, Types::String
