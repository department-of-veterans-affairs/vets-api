...
gem 'jwt'
gem 'levenshtein-ffi'
gem 'lighthouse_bgs', git: 'https://github.com/department-of-veterans-affairs/lighthouse-bgs.git', path: '/Users/derekdyer/Documents/lighthouse-bgs', branch: 'kc-6189-vnp-proc-service-v2'
gem 'liquid'
gem 'mail', '2.7.1'
gem 'memoist'
