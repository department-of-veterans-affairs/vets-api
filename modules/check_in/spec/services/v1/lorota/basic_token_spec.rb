...
describe V1::Lorota::BasicToken do
  ...
  describe '.build' do
    it 'returns an instance of Token' do
      expect(subject).to be_an_instance_of(V1::Lorota::BasicToken)
    end
  end
  ...
  describe '#fetch' do
    ...
    it 'returns an instance of Token' do
      expect(subject.fetch).to be_an_instance_of(V1::Lorota::BasicToken)
    end
