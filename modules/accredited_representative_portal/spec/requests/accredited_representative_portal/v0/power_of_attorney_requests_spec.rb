...
RSpec.describe AccreditedRepresentativePortal::V0::PowerOfAttorneyRequestsController, type: :request do
  ...
  let(:created_at) { "2024-12-21T04:45:37.000Z" }
  let(:time_plus_one_day) { "2024-12-22T04:45:37Z" }
  let(:created_at_plus_one_day) { "2024-12-22T04:45:37.000Z" }
  ...
  let(:poa_requests) do
    ...
    [].tap do |memo|
      ...
      # memo << create(:power_of_attorney_request, :with_acceptance, :with_static_power_of_attorney_form )
      memo << create(:power_of_attorney_request_resolution, :acceptance,
                     created_at: time_plus_one_day).power_of_attorney_request
  ...
  describe 'GET /accredited_representative_portal/v0/power_of_attorney_requests' do
    ...
    #           'type' => 'decision',
    #           'created_at' => created_at_plus_one_day,
