...
module IncreaseCompensation
  module IbmConverter
    ...
    MAPPINGS = {
      ...
      'CLAIMANT_SIGNATURE' => ->(data) { data['signature'] || data['statementOfTruthSignature'] || data[] },
    ...
    def self.convert(form_data)
      MAPPINGS.transform_values { |proc| proc.call(form_data) }
    end
