...
RSpec.describe StatsdMiddleware, type: :request do
  ...
  it 'sends status data to statsd' do
    ...
    tags = %w[controller:my_health/v1/prescriptions action:index source_app:not_provided status:200]
    expect do
  ...
  it 'sends duration data to statsd' do
    stub_varx_request(:get, 'mhv-api/patient/v1/prescription/gethistoryrx', history_rxs, status_code: 200)
    tags = %w[controller:my_health/v1/prescriptions action:index source_app:not_provided]
    expect do
      get '/my_health/v1/prescriptions'
  ...
  it 'sends db_runtime data to statsd' do
    stub_varx_request(:get, 'mhv-api/patient/v1/prescription/gethistoryrx', history_rxs, status_code: 200)
    tags = %w[controller:my_health/v1/prescriptions action:index status:200]
    expect do
      get '/my_health/v1/prescriptions'
  ...
  it 'sends source_app to statsd' do
    stub_varx_request(:get, 'mhv-api/patient/v1/prescription/gethistoryrx', history_rxs, status_code: 200)
    tags = %w[controller:my_health/v1/prescriptions action:index source_app:profile status:200]
    expect do
  ...
  it 'sends undefined to statsd when source_app is undefined' do
    stub_varx_request(:get, 'mhv-api/patient/v1/prescription/gethistoryrx', history_rxs, status_code: 200)
    tags = %w[controller:my_health/v1/prescriptions action:index source_app:undefined status:200]
    expect do
      get '/my_health/v1/prescriptions', headers: { 'Source-App-Name' => 'undefined' }
    end.to trigger_statsd_increment(StatsdMiddleware::STATUS_KEY, tags:, times: 1)
  end

  it 'uses not_in_allowlist for source_app when the value is not in allow list' do
    stub_varx_request(:get, 'mhv-api/patient/v1/prescription/gethistoryrx', history_rxs, status_code: 200)
    tags = %w[controller:my_health/v1/prescriptions action:index source_app:not_in_allowlist status:200]
    expect do
      get '/my_health/v1/prescriptions', headers: { 'Source-App-Name' => 'foo' }
    end.to trigger_statsd_increment(StatsdMiddleware::STATUS_KEY, tags:, times: 1)
  end
