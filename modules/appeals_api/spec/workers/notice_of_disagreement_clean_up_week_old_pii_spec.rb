  ...
  describe '#perform' do
    ...
    context 'when pii_expunge flag is enabled' do
      it 'calls AppealsApi::RemovePii' do
        with_settings(Settings.modules_appeals_api, notice_of_disagreement_pii_expunge_enabled: true) do
    ...
    context 'when pii_expunge flag is disabled' do
      it 'does not call AppealsApi::RemovePii' do
        with_settings(Settings.modules_appeals_api, notice_of_disagreement_pii_expunge_enabled: false) do
          described_class.new.perform
