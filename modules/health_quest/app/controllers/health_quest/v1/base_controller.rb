...
module HealthQuest
  module V1
    ...
    class BaseController < HealthQuest::V0::BaseController
      ...
      def fhir_service
        HealthQuest::V1::FHIRService.new(
      ...
      def render_errors(va_exception)
        ...
        id = params[:id]
        operation_outcome = HealthQuest::V1::OperationOutcome.new(
          resource_type: resource_type,
          id: id,
          issue: va_exception
        )

        serializer = HealthQuest::V1::OperationOutcomeSerializer.new(operation_outcome)
