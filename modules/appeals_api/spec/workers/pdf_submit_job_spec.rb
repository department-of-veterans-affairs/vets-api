...
RSpec.describe AppealsApi::PdfSubmitJob, type: :job do
  ...
  describe 'uploads a valid payload' do
    it 'NOD' do
      Timecop.freeze(DateTime.new(2020, 1, 1).utc) do
        ...
        described_class.new.perform(notice_of_disagreement.id, appeal_class: AppealsApi::NoticeOfDisagreement)
  ...
  context 'an error throws' do
    it 'updates the NOD status to reflect the error' do
      ...
      expect do
        submit_job_worker.perform(notice_of_disagreement.id, appeal_class: AppealsApi::NoticeOfDisagreement)
