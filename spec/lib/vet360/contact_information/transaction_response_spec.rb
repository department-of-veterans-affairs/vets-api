    ...
    context 'with a response error' do
      let(:body) do
        {"tx_audit_id"=>"1a44d122-176e-45a2-8726-083e89fdeb15",
         ...
         "tx_messages"=>
          [{"code"=>"ADDRVAL112", "key"=>"addressBio.AddressCouldNotBeFound", "text"=>"The Address could not be found", "severity"=>"ERROR"},
           {"code"=>"ADDR306", "key"=>"addressBio.lowConfidenceScore", "text"=>"VaProfile Validation Failed: Confidence Score less than 80", "severity"=>"ERROR"},
           {"code"=>"ADDR305", "key"=>"addressBio.deliveryPointNotConfirmed", "text"=>"VaProfile Validation Failed: Delivery Point is Not Confirmed for Domestic Residence", "severity"=>"ERROR"}]}
      end
