...
describe CovidVaccine::V0::ExpandedRegistrationService do
  ...
  let(:form_data) do
    { 'vaccine_interest' => 'INTERESTED', 'phone' => '650-555-1212',
      ...
      'ssn' => '666512797', 'zip_code' => '97412', 'preferred_facility' => 'vha_999',
  ...
  let(:insufficient_submission) do
    build(:covid_vax_expanded_registration,
      :unsubmitted,
      :lacking_pii_traits)
  end
  
  let(:mvi_profile) { build(:mvi_profile, { vha_facility_ids: %w[516 553 200HD 200IP 200MHV] }) }
