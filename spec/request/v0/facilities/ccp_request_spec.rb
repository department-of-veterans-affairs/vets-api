...
RSpec.describe 'Community Care Providers', type: :request, team: :facilities do
  ...
  around do |example|
    VCR.insert_cassette('facilities/ppms/ppms', match_requests_on: %i[path query], allow_playback_repeats: true)
    VCR.insert_cassette('facilities/ppms/ppms_new_query', match_requests_on: %i[path query], allow_playback_repeats: true)
    example.run
