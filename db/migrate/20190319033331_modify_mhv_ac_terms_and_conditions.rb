class ModifyMhvAcTermsAndConditions < ActiveRecord::Migration[4.2]
  ...
  def up
    ...
    header_content = <<-EOF
<div>
  Once you agree to these Terms and Conditions, you’ll be able to use VA online health tools to:
  <ul>
...
EOF
    ...
    terms_content = <<-EOF
<div>
  <p>The Department of Veterans Affairs (VA) owns and manages VA.gov and the My HealtheVet health management portal. VA.gov allows you to use online tools that display parts of your personal health information. This health information is only displayed on VA.gov—the information is stored on VA protected federal computer systems and networks. VA supports the secure storage and transmission of all information on VA.gov.</p>

  <p><strong>Medical Disclaimer</strong></p>
  <p>The medical and health content displayed on VA.gov is intended for use as an informative tool by the user. It is not intended to be, and should not be used in any way as, a substitute for professional medical advice. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition. The accuracy of the information provided is not guaranteed. The user acknowledges the information is not meant to diagnose a health condition or disease and is not meant to develop a health treatment plan.</p>

  <p><strong>Your VA Health Records</strong></p>
  <p>VA is committed to keeping your health information private. The portions of your VA health records seen on VA.gov are electronic copies of your official VA health records. Your VA health records remains the official and authoritative VA health records. If you disagree with the content of your health records, contact your facility Release of Information Office or facility Privacy Officer.</p>

  <p>By using VA.gov and the My HealtheVet health management portal, you are requesting and giving VA permission to release to you all or a portion of your personal health information maintained by VA through VA.gov.</p>

  <p>If your health information is not available on VA.gov, you need to contact your facility Release of Information Office or facility Privacy Officer.</p>
  ...
  <p>You must agree to these Terms and Conditions to use personal health tools on VA.gov. By agreeing to these terms and conditions you are also agreeing to your responsibilities as stated in the VA.gov Privacy Policy.</p>
</div>
EOF
  ...
  <p>When you use secpure messaging, you are expected to follow certain standards of conduct. Violations may result in being blocked from using secure messaging. Unacceptable conduct includes, but is not limited to using secure messaging to send profane or threatening messages or other inappropriate uses as determined by your health care facility</p>
