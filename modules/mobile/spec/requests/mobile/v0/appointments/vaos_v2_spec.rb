...
RSpec.describe 'Mobile::V0::Appointments::VAOSV2', type: :request do
  ...
  shared_context 'appointments flipper setup' do |parallel_api_calls_enabled|
    before do
  ...
  [false, true].each do |parallel_api_calls_enabled|
    context "with appointments_parallel_api_calls #{parallel_api_calls_enabled ? 'enabled' : 'disabled'}" do
      include_context 'appointments flipper setup', parallel_api_calls_enabled
