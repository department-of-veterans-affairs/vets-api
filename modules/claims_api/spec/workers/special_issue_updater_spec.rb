...
RSpec.describe ClaimsApi::SpecialIssueUpdater, type: :job do
  ...
  it 'submits successfully' do
    expect do
      subject.perform_async(user, contention_id, special_issues, target_vet_participant_id, claim_record.id)
  ...
  context 'when no matching claim is found' do
    ...
    it 'job fails and retries later' do
      ...
      expect do
        subject.new.perform(user, contention_id, special_issues, target_vet_participant_id, claim_record.id)
