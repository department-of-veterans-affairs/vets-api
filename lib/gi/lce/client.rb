  ...
  module LCE
    class Client < GI::Client
      ...
      def get_license_details_v1(params = {})
        ...
        response = perform(:get, "v1/licenses/#{license_id}")
      end

      def get_certification_details_v1(params = {})
        certification_id = params[:id]
        response = perform(:get, "v1/certifications/#{certification_id}")
      end

      def get_prep_details_v1(params = {})
        prep_id = params[:id]
        response = perform(:get, "v1/preps/#{prep_id}")
      end

      def get_exam_details_v1(params = {})
        exam_id = params[:id]
        response = perform(:get, "v1/exams/#{exam_id}")
      end
    end
  end
end