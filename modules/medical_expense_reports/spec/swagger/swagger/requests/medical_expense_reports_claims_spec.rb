...
RSpec.describe Swagger::Requests::MedicalExpenseReportsClaims, skip: 'TODO after schema built',
  ...
  let(:full_claim) do
    build(:medical_expense_reports_claim).parsed_form
  end

  describe 'POST create' do
    subject do
      post '/medical_expense_reports/v0/form8416',
