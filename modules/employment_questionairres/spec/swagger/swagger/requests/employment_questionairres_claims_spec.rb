...
# RSpec.describe Swagger::Requests::EmploymentQuestionairresClaim, skip: 'TODO after schema built',
...
#   let(:full_claim) do
#     build(:employment_questionairres_claim).parsed_form
#   end

#   describe 'POST create' do
#     subject do
#       post '/employment_questionairres/v0/form8416',
