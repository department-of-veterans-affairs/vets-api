...
module EmploymentQuestionnaires
  module V0
    ###
    # The Empolyment questionnairesss claim controller that handles form submissions
    #
    class ClaimsController < ClaimsBaseController
      before_action :check_flipper_flag
      service_tag 'employment-questionnaires-application'
      ...
      # GET serialized Empolyment questionnairesss form data
      def show
      ...
      def create
        ...
        EmploymentQuestionnaires::BenefitsIntake::SubmitClaimJob.perform_async(claim.id,
      ...
      # Raises an exception if the Empolyment questionnairesss flipper flag isn't enabled.
      def check_flipper_flag
        raise Common::Exceptions::Forbidden unless Flipper.enabled?(:employment_questionnaires_form_enabled,
                                                                    current_user)
      end
      ...
      # @param claim [EmploymentQuestionnaires::SavedClaim]
      #
      ...
      #
      # @return [EmploymentQuestionnaires::Monitor]
      #
      def monitor
