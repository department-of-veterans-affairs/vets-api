    ...
    it 'should merge the right fields' do
      expect(described_class.new(form_data).merge_fields).to eq(
        {"veteranFullName"=>"john middle smith Sr.",
         ...
         "netWorths" => [{"recipient"=>"Myself", "amount"=>1}, {"recipient"=>"Myself", "amount"=>2}, {"recipient"=>"Myself", "amount"=>3}, {"recipient"=>"Spouse", "amount"=>4}, {"recipient"=>"Spouse", "amount"=>5}, {"recipient"=>"Myself", "amount"=>6}, {"recipient"=>"Spouse", "amount"=>7}, {"recipient"=>"outside1 Olson", "amount"=>8, "additionalSourceName"=>"name1"}],
         "netWorth" => {"bank"=>1, "interestBank"=>2, "ira"=>3, "otherProperty"=>6},
         "spouseNetWorth" => {"stocks"=>4, "realProperty"=>5, "otherProperty"=>7},
         "outsideChildren" => [{"childAddress"=>"str1, city1, MD, 21231, USA", "childFullName"=>"outside1 Olson", "childNotInHousehold"=>true, "personWhoLivesWithChild"=>"person1 Olson", "netWorth"=>{"additionalSources"=>[{"name"=>"name1", "amount"=>8}]}, "monthlyPayment"=>1}, {"childAddress"=>"str2, city1, MD, 21231, USA", "childFullName"=>"outside2 Olson", "personWhoLivesWithChild"=>"person2 Olson", "childNotInHousehold"=>true, "monthlyPayment"=>2}, {"childAddress"=>"str3, city1, MD, 21231, USA", "childFullName"=>"outside3 Olson", "personWhoLivesWithChild"=>"person3 Olson", "childNotInHousehold"=>true, "monthlyPayment"=>3}],
