  ...
  context 'when find_a_representative_use_accredited_models is enabled' do
    ...
    context 'when the search is invalid' do
      ...
      context 'when the type param is invalid' do
        it 'returns a bad request error' do
          get path, params: { type: 'abc', lat:, long: }
      ...
      context 'when the sort param is invalid' do
        it 'returns a bad request error' do
          get path, params: { type:, lat:, long:, sort: 'abc' }
      ...
      context 'when lat is not a number' do
        it 'returns a bad request error' do
          get path, params: { type:, lat: 'abc', long: }
      ...
      context 'when lat is not in the allowed range' do
        it 'returns a bad request error' do
          get path, params: { type:, lat: 90.01, long: }
      ...
      context 'when long is not a number' do
        it 'returns a bad request error' do
          get path, params: { type:, lat:, long: 'abc' }
      ...
      context 'when long is not in the allowed range' do
        it 'returns a bad request error' do
          get path, params: { type:, lat:, long: -180.01 }
      ...
      context 'when distance is not a number' do
        it 'returns a bad request error' do
          get path, params: { type:, lat:, long:, distance: 'abc' }
      ...
      context 'when distance is not an allowed value' do
        it 'returns a bad request error' do
          get path, params: { type:, lat:, long:, distance: 42 }
