          ...
          property :data, type: :array, maxItems: 10, uniqueItems: true do
            items do
              ...
              property :attributes do
                ...
                property :length_in_hours, type: %i[null string], example: '680', description: 'Length of program (in hours)'
                property :length_in_weeks, type: %i[null integer], example: 12, description: 'Length of program (in weeks)'
                ...
                property :city, type: %i[null string], example: 'ANYTOWN', description: 'Program institution physical city location'
                property :state, type: %i[null string], example: 'WA', description: 'Program institution physical state location'
                property :country, type: %i[null string], example: 'USA', description: 'Program institution physical country location'
                property :preferred_provider, type: %i[null boolean], example: false, 
                description: 'Program institution preferred provider indicator; a provider that takes on the costs of the veterans education if the requirements are not met'
                property :tuition_amount, type: %i[null integer], example: 1000, description: 'Program tuition amount'
                property :va_bah, type: %i[null number], example: 220, description: 'VA Basic Allowance for Housing'
                property :dod_bah, type: %i[null integer], example: 200,  description: 'DOD Basic Allowance for Housing'
              end
            end
          end
