...
The statuses have a final_status attribute that indicates whether the status of the evidence is final. Evidence submissions with a final_status of true will no longer update to a new status.
