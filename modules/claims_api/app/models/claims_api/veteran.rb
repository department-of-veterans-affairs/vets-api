...
module ClaimsApi
  class Veteran
    ...
    def ssn=(new_ssn)
      raise Common::Exceptions::Internal::ParameterMissing, 'X-VA-SSN' unless SSN_REGEX.match?(new_ssn)
    ...
    def va_profile=(new_va_profile)
      ...
      raise Common::Exceptions::Internal::ParameterMissing, 'X-VA-Birth-Date' unless matches
