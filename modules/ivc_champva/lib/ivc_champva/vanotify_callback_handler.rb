module IvcChampva
    ...
    class ZsfEmailNotificationCallback
      def self.call(notification)
        # @param ac [hash] contains properties form_id and form_uuid (e.g.: {form_id: '10-10d', form_uuid: '12345678-1234-5678-1234-567812345678'})
        ...
        when 'delivered'
          ...
          monitor.log_silent_failure_avoided(ac, nil, caller_locations.first, true) # Log with email_confirmed
