...
RSpec.describe BEP::People::Request do
  ...
  describe '#find_person_by_participant_id' do
    subject { BEP::People::Request.new.find_person_by_participant_id(user:) }
    ...
    context 'when user has a participant id' do
      ...
      context 'and user is found in bep' do
        it 'returns a bep people response' do
        ...
        it 'caches the filled response' do
          ...
          cached_response = BEP::People::Request.find(participant_id).response
      ...
      context 'and user is not found in bep' do
      ...
      context 'and bep returns a server error' do
        ...
        it 'does not cache the response' do
          ...
          expect(bep::People::Request.find(participant_id)).to be_nil
        end
      end
    end
