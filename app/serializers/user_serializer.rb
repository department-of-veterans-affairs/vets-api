...
class UserSerializer < ActiveModel::Serializer
  ...
  def services
    ...
    service_list << BackendServices::RX if object.authorize :rx, :access?
    service_list << BackendServices::MESSAGING if object.authorize :messaging, :access?
    service_list << BackendServices::HEALTH_RECORDS if object.authorize :health_records, :access?
    service_list << BackendServices::MHV_AC if object.authorize :account_creation, :access?
