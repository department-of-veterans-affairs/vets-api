...
require 'va_profile/profile_information/transaction_response'

describe VAProfile::ProfileInformation::TransactionResponse do
  describe '.from' do
    subject { described_class.from(raw_response) }

    let(:raw_response) { OpenStruct.new(body:) }

    describe VAProfile::ProfileInformation::AddressTransactionResponse do
      let(:body) do
        {
    ...
    describe VAProfile::ProfileInformation::TelephoneTransactionResponse do
      let(:body) do
        {
          'tx_audit_id' => 'a2af8cd1-472c-4e6f-bd5a-f95e31e351b7',
          'status' => 'COMPLETED_SUCCESS',
    ...
    describe VAProfile::ProfileInformation::EmailTransactionResponse do
      let(:body) do
    ...
    describe VAProfile::ProfileInformation::PersonTransactionResponse do
