...
module ClaimLetterTestData
  ...
  TEST_DATA = [
    OpenStruct.new(
      ...
      display_description: 'A human-readable description of Decision Rating',
      type_id: '340',
      doc_type: '340',
      subject: nil,
    ...
    OpenStruct.new(
      ...
      display_description: 'Claim decision (or other notification, like Intent to File)',
      type_id: '184',
      doc_type: '184',
      subject: nil,
      received_at: Date.new(2009,5,12),
    ...
    OpenStruct.new(
      ...
      display_description: 'Board decision',
      type_id: '27',
      doc_type: '27',
      subject: nil,
    ...
    OpenStruct.new(
      ...
      display_description: 'List of evidence we may need ("5103 Notice")',
      type_id: '704',
      doc_type: '704',
      subject: nil,
    ...
    OpenStruct.new(
      ...
      display_description: 'Request for specific evidence or information',
      type_id: '34',
      doc_type: '34',
      subject: nil,
      received_at: Date.new(2023,1,24),
    ...
    OpenStruct.new(
      ...
      display_description: 'Notification: Exam with VHA has been scheduled',
      type_id: '408',
      doc_type: '408',
      subject: nil,
      received_at: Date.new(2023,1,24),
    ...
    OpenStruct.new(
      ...
      display_description: 'Copy of request for medical records sent to a non-VA provider',
      type_id: '864',
      doc_type: '864',
      subject: nil,
      received_at: Date.new(2023,1,24),
    ...
    OpenStruct.new(
      ...
      display_description: 'Final notification: Request for specific evidence or information',
      type_id: '942',
      doc_type: '942',
      subject: nil,
      received_at: Date.new(2023,1,24),
    ...
    OpenStruct.new(
      ...
      display_description: 'Copy of request for non-medical records sent to a non-VA organization',
      type_id: '1605',
      doc_type: '1605',
      subject: nil,
      received_at: Date.new(2023,1,24),
