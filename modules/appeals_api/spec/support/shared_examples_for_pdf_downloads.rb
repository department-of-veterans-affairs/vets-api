...
shared_examples 'PDF download docs' do |opts|
  ...
  description <<~DESC
    ...
    The 'icn' parameter is required when accessing this endpoint using an OAuth token with the '#{(opts[:scopes] - veteran_scopes).join("' or '")}' scopes.
