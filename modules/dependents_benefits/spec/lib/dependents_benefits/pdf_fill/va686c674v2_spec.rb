...
require 'dependents_verification/pdf_fill/va686c674v2'
require 'lib/pdf_fill/fill_form_examples'

def basic_class
  DependentsVerification::PdfFill::Va686c674v2.new({})
end

describe DependentsVerification::PdfFill::Va686c674v2 do
  let(:form_data) do
    JSON.parse(File.read("#{DependentsBenefits::MODULE_PATH}/spec/fixtures/pdf_fill/686C-674-V2/kitchen_sink.json"))
  end

  let(:path) { 'modules/dependents_benefits/lib/dependents_benefits/pdf_fill/pdfs/686c-674-v2.pdf' }
  let :keys do
    def get_keys(hash)
