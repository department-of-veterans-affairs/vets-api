...
describe Facilities::PPMS::Response do
  ...
  let(:caresites_response_body) do 
    [
      {
        "Name"=>"123 Main Street, Manassas, VA, 20111", "Id"=>"62bdd2b1-9dd1-e8111-12346324daqe4", 
        "Latitude"=>38.8, "Longitude"=>-76.6, "Street"=>"123 Main Street"
      }
    ]
  end
  ...
  let(:provider_locator_body) do
    [
      {
          "Miles"=>7.47076307768083, "Minutes"=>11.5083333333333, 
      ...
      }, 
      {
          ...
          "Latitude"=>38.86787, "Longitude"=>-78.17305
      }, 
      {
          ...
          "Latitude"=>39.16996, "Longitude"=>-78.18052
      }
    ]
  end
  ...
  let(:services_response_body) do 
    [
      {
        "Name"=>"Danzer, Hal  - Obstetrics & Gynecology    ", "AffiliationName"=>"TriWest", "ProviderName"=>"Danzer, Hal ", 
        "ProviderAgreementName"=>nil, "SpecialtyName"=>"Obstetrics & Gynecology   ", "ProviderSpecialtyName"=>nil, 
        "CareSiteLocationAddress"=>"SOUTHERN CALIF REPRODUCTIVE CTR MED GRP INC", "Longitude"=>-122.5, "Latitude"=>45.8, 
        "CareSiteAddressStreet"=>"123 test street", "CareSiteAddressZipCode"=>"11111", "CareSiteAddressCity"=>"Testville", 
        "CareSiteAddressState"=>"VA", "CareSitePhoneNumber"=>"(888) 444-1234", "OrganiztionGroupName"=>nil, "DescriptionOfService"=>nil, 
        "Limitation"=>nil}, {"Name"=>"Danzer, Hal  - Obstetrics & Gynecology - Reproductive Endocrinology  ", "AffiliationName"=>"TriWest", 
          "ProviderName"=>"Danzer, Hal ", "ProviderAgreementName"=>nil, "SpecialtyName"=>"Obstetrics & Gynecology - Reproductive Endocrinology ", 
          "ProviderSpecialtyName"=>nil, "CareSiteLocationAddress"=>"SOUTHERN CALIF REPRODUCTIVE CTR MED GRP INC", "CareSitePhoneNumber"=>nil, 
          "OrganiztionGroupName"=>nil, "DescriptionOfService"=>nil, "Limitation"=>nil
      }
    ]
  end
  ...
  let(:specialties_response_body) do 
    [
         {
          "SpecialtyCode"=>"101Y00000X", "Name"=>"Counselor   ", "Grouping"=>"Behavioral Health & Social Service Providers", 
          "Classification"=>"Counselor", "Specialization"=>nil, 
          "SpecialtyDescription"=>"A provider who is trained and educated in the performance of behavior health services 
           through interpersonal communications and analysis. Training and education at the specialty level usually requires a master’s 
           degree and clinical experience and supervision for licensure or certification."
         }, 
         { 
           "SpecialtyCode"=>"101YA0400X", "Name"=>"Counselor - Addiction (Substance Use Disorder) ", 
           "Grouping"=>"Behavioral Health & Social Service Providers", "Classification"=>"Counselor", 
