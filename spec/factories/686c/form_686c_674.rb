    ...
    initialize_with do
      {
        ...
        'dependents_application' => {
          ...
          'veteran_contact_information'=>
            ...
            'veteran_address'=>{'country'=>'USA', 'street'=>'123 fake street', 'street2'=>'test2', 'street3'=>'test3', 'city'=>'portland', 'state'=>'ME', 'postal_code'=>'04102'}},
          'view:remove_dependent_options'=>
            ...
            'report_marriage_of_child_under18'=>true,
            'report_child18_or_older_is_not_attending_school'=>true},
          'view:add_dependent_options'=>{'add_spouse'=>true, 'add_child'=>true, 'report674'=>true, 'add_disabled_child'=>true},
          ...
          'children_to_add'=>
            [{'income_in_last_year'=>false,
              ...
              'marriage_end_description'=>'woops!',
              'does_child_live_with_you'=>true,
              'has_child_ever_been_married'=>true,
              'relationship_to_child'=>{'biological'=>true},
              'birth_location'=>{'location'=>{'state'=>'NH', 'postal_code'=>'03301'}},
              'ssn'=>'987654321',
              'full_name'=>{'first'=>'first', 'middle'=>'middle', 'last'=>'child'},
              'birth_date'=>'2005-01-01'}],
          'student_information'=>
            [{'remarks'=>'test additional information',
              'student_networth_information'=>{'savings'=>'500', 'securities'=>'400', 'real_estate'=>'300', 'other_assets'=>'200', 'total_value'=>'1400'},
              'student_expected_earnings_next_year'=>
              {'earnings_from_all_employment'=>'56000', 'annual_social_security_payments'=>'0', 'other_annuities_income'=>'145', 'all_other_income'=>'50'},
              'student_earnings_from_school_year'=>
              {'earnings_from_all_employment'=>'56000', 'annual_social_security_payments'=>'0', 'other_annuities_income'=>'123', 'all_other_income'=>'20'},
              'claims_or_receives_pension'=>true,
              'school_information'=>
              {'last_term_school_information'=>{'term_begin'=>'2024-01-01', 'date_term_ended'=>'2024-03-05'},
                'student_did_attend_school_last_term'=>true,
                'current_term_dates'=>{'official_school_start_date'=>'2025-01-01', 'expected_student_start_date'=>'2025-01-02', 'expected_graduation_date'=>'2026-03-01'},
                'is_school_accredited'=>true,
              ...
              'was_married'=>true,
              'address'=>{'country'=>'USA', 'street'=>'123 fake street', 'street2'=>'line2', 'street3'=>'line3', 'city'=>'portland', 'state'=>'ME', 'postal_code'=>'04102'},
              'student_income'=>true,
              'ssn'=>'987654321',
              'is_parent'=>true,
