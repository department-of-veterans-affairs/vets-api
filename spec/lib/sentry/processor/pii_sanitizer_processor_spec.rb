      ...
      let(:data) do
        {
          ...
          va_eauth_phone: ['(503)111-2487'],
          va_eauth_lastname: ['ALLEN'],
          va_eauth_aal_idme_highest: ['2'],
          va_eauth_ial: ['2'],
          va_eauth_icn: ['1008704012V552302'],
          va_eauth_city: ['FAIRFAX'],
          ...
          va_eauth_emailaddress: ['vets.gov.user+0@gmail.com'],
          va_eauth_cspid: ['200VIDM_88f572d491af46efa393cba6c351e252'],
          va_eauth_authncontextclassref: ['http://idmanagement.gov/ns/assurance/loa/3'],
          va_eauth_issueinstant: ['2020-04-03T11:42:43Z'],
          va_eauth_middlename: ['J'],
          va_eauth_birthDate_v1: ['19320205'],
          va_eauth_state: ['VA'],
          va_eauth_birlsfilenumber: ['796126859'],
          va_eauth_postalcode: ['20110'],
          va_eauth_street3: ['NOT_FOUND'],
          va_eauth_csid: ['idme'],
          va_eauth_proofingAuthority: ['FICAM'],
          va_eauth_pid: ['600043186'],
          va_eauth_credentialassurancelevel: ['3'],
          va_eauth_pnidtype: ['SSN'],
          va_eauth_mcid: ['WSSOE2004030743006802010920277'],
          va_eauth_firstname: ['HECTOR'],
          va_eauth_prefix: ['NOT_FOUND'],
          va_eauth_street: ['FAIRLAKE CIRCLE'],
          va_eauth_csponly: ['false'],
          va_eauth_pnid: ['796126859'],
          va_eauth_commonname: ['vets.gov.user+0@gmail.com'],
          va_eauth_transactionid: ['qeG0ZbnqqD7NbNkBzNAXOt6vBz1YB+wYci7RgCATVZE='],
          va_eauth_suffix: ['NOT_FOUND'],
          va_eauth_uid: ['88f572d491af46efa393cba6c351e252'],
          va_eauth_isDelegate: ['false'],
          va_eauth_secid: ['1008704012'],
          va_eauth_gcIds: ['1008704012V552302^NI^200M^USVHA^P|600043186^PI^500^USVHA^A|796126859^PI^200BRLS^USVBA^A|' \
            '1008704012^PN^200PROV^USDVA^A|60043186^PI^200CORP^USVBA^A|1005329660^PN^200VMOCK^USDVA^A|' \
            '88f572d491af46efa393cba6c351e252^PN^200VIDM^USDVA^A'],
          va_eauth_persontype: ['NOT_FOUND'],
          va_eauth_multifactor: ['true'],
          va_eauth_street1: ['FAIRLAKE CIRCLE'],
      ...
      it 'correctly filters pii from saml response attributes' do
        expect(result)
          .to eq(
            ...
            multifactor: [true],
            uuid: ['7ff6f2e7ac774ddc835sdfkjhsdflkj'],
            va_eauth_phone: ['FILTERED-CLIENTSIDE'],
            va_eauth_lastname: ['FILTERED-CLIENTSIDE'],
            va_eauth_aal_idme_highest: ['2'],
            va_eauth_ial: ['2'],
            va_eauth_icn: ['1008704012V552302'],
            va_eauth_city: ['FILTERED-CLIENTSIDE'],
            va_eauth_ial_idme_highest: ['classic_loa3'],
            va_eauth_country: ['FILTERED-CLIENTSIDE'],
            va_eauth_csp_identifier: ['200VIDM'],
            va_eauth_gender: ['FILTERED-CLIENTSIDE'],
            va_eauth_street2: ['FILTERED-CLIENTSIDE'],
            va_eauth_aal: ['2'],
            va_eauth_csp_method: ['IDME'],
            va_eauth_dodedipnid: ['NOT_FOUND'],
            va_eauth_emailaddress: ['FILTERED-CLIENTSIDE'],
            va_eauth_cspid: ['200VIDM_88f572d491af46efa393cba6c351e252'],
            va_eauth_authncontextclassref: ['http://idmanagement.gov/ns/assurance/loa/3'],
            va_eauth_issueinstant: ['2020-04-03T11:42:43Z'],
            va_eauth_middlename: ['FILTERED-CLIENTSIDE'],
            va_eauth_birthDate_v1: ['FILTERED-CLIENTSIDE'],
            va_eauth_state: ['FILTERED-CLIENTSIDE'],
            va_eauth_birlsfilenumber: ['FILTERED-CLIENTSIDE'],
            va_eauth_postalcode: ['FILTERED-CLIENTSIDE'],
            va_eauth_street3: ['FILTERED-CLIENTSIDE'],
            va_eauth_csid: ['idme'],
            va_eauth_proofingAuthority: ['FICAM'],
            va_eauth_pid: ['600043186'],
            va_eauth_credentialassurancelevel: ['3'],
            va_eauth_pnidtype: ['FILTERED-CLIENTSIDE'],
            va_eauth_mcid: ['WSSOE2004030743006802010920277'],
            va_eauth_firstname: ['FILTERED-CLIENTSIDE'],
            va_eauth_prefix: ['NOT_FOUND'],
            va_eauth_street: ['FILTERED-CLIENTSIDE'],
            va_eauth_csponly: ['false'],
            va_eauth_pnid: ['FILTERED-CLIENTSIDE'],
            va_eauth_commonname: ['FILTERED-CLIENTSIDE'],
            va_eauth_transactionid: ['qeG0ZbnqqD7NbNkBzNAXOt6vBz1YB+wYci7RgCATVZE='],
            va_eauth_suffix: ['NOT_FOUND'],
            va_eauth_uid: ['88f572d491af46efa393cba6c351e252'],
            va_eauth_isDelegate: ['false'],
            va_eauth_secid: ['1008704012'],
            va_eauth_gcIds: ['FILTERED-CLIENTSIDE'],
            va_eauth_persontype: ['NOT_FOUND'],
            va_eauth_multifactor: ['true'],
            va_eauth_street1: ['FILTERED-CLIENTSIDE'],
            va_eauth_mhvien: ['NOT_FOUND']
          )
      end
    end
