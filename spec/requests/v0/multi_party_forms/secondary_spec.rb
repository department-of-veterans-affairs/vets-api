...
RSpec.describe 'V0::MultiPartyForms::Secondary', type: :request do
  ...
  # TODO: Uncomment when MultiPartyFormSubmission model/factory is merged
  # let(:submission) do
  #   create(
  ...
  describe 'POST /v0/multi_party_forms/secondary/:id/start' do
    ...
    context 'when feature flag is disabled' do
      ...
      it 'returns not found' do
        ...
        post "/v0/multi_party_forms/secondary/#{submission_id}/start",
             params: { token: 'stub-token' },
             as: :json
    ...
    context 'when authenticated and feature flag enabled' do
      ...
      it 'returns submission JSON with stubbed response' do
        # TODO: Uncomment when MultiPartyFormSubmission model/factory is merged
        # token = submission.generate_secondary_access_token!

        post "/v0/multi_party_forms/secondary/#{submission_id}/start",
             params: { token: 'stub-token' }.to_json,
      ...
      #   expect(response).to have_http_status(:forbidden)
      #   json_response = JSON.parse(response.body)
      #   expect(json_response['errors'].first['detail']).to match(/invalid or has expired/)
      # end
      #
      ...
      #   json_response = JSON.parse(response.body)
      #   expect(json_response['errors'].first['title']).to eq('Invalid submission state')
      # end
      #
      ...
      #   post '/v0/multi_party_forms/secondary/00000000-0000-0000-0000-000000000000/start',
