  ...
  context 'has valid paths' do
    ...
    describe 'profiles' do
      ...
      it 'supports updating a va profile email' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/put_email_success') do
      ...
      it 'supports posting va_profile email address data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/post_email_success') do
          email_address = build(:email)
      ...
      it 'supports deleting va_profile email address data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/delete_email_success') do
          email_address = build(:email, id: 42)
      ...
      it 'supports updating va_profile telephone data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/put_telephone_success') do
      ...
      it 'supports posting va_profile telephone data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/post_telephone_success') do
          telephone = build(:telephone)
      ...
      it 'supports deleting va_profile telephone data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/delete_telephone_success') do
          telephone = build(:telephone, id: 42)
      ...
      it 'supports va_profile create or update address api' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/put_address_success') do
      ...
      it 'supports posting va_profile address data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/post_address_success') do
          address = build(:va_profile_address)
      ...
      it 'supports deleting va_profile address data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/delete_address_success') do
          address = build(:va_profile_address, id: 42)
      ...
      it 'supports updating va_profile permission data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/put_permission_success') do
      ...
      it 'supports posting va_profile permission data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/post_permission_success') do
          permission = build(:permission)
      ...
      it 'supports deleting va_profile permission data' do
        ...
        VCR.use_cassette('va_profile/contact_information/v1/delete_permission_success') do
