    ...
    class Organization < ClaimsApi::PoaPdfConstructor::Base
      ...
      def page1_options(data)
        base_form = 'F[0].Page_1[0]'
        {
          ...
          "#{base_form}.Claimants_MailingAddress_StateOrProvince[1]": retrieve_state(data),
          "#{base_form}.Claimants_MailingAddress_Country[1]": data.dig('veteran', 'address', 'country'),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[1]": retrieve_zip_code_first_five(data),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_LastFourNumbers[1]": retrieve_zip_code_last_four(data),
          ...
          "#{base_form}.Claimants_MailingAddress_NumberAndStreet[0]": retrieve_street_address(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_ApartmentOrUnitNumber[0]": retrieve_unit_or_apartment(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_City[0]": data.dig('claimant', 'address', 'city'),
          "#{base_form}.Claimants_MailingAddress_StateOrProvince[0]": retrieve_state(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_Country[0]": data.dig('claimant', 'address', 'country'),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[0]": retrieve_zip_code_first_five(data, 'claimant'),
          "#{base_form}.Claimants_MailingAddress_ZIPOrPostalCode_LastFourNumbers[0]": retrieve_zip_code_last_four(data, 'claimant'),
