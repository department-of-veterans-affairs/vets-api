...
module IncreaseCompensation
  module BenefitsIntake
    ...
    class SubmitClaimJob
      ...
      # Error if "Unable to find IncreaseCompensation::SavedClaim"
      class IncreaseCompensationBenefitIntakeError < StandardError; end
      ...
      def init(saved_claim_id, user_account_uuid)
        ...
        @claim = IncreaseCompensation::SavedClaim.find(saved_claim_id)
        unless @claim
      ...
      def lighthouse_submission_polling
        ...
        Lighthouse::SubmissionAttempt.transaction do
          ...
          @lighthouse_submission_attempt =
            Lighthouse::SubmissionAttempt.create(
