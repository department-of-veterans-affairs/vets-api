...
RSpec.describe AccreditedRepresentativePortal::OgcClient do
  ...
  describe '#find_registration_numbers_for_icn' do
    ...
    context 'when accredited_representative_portal_disable_ogc_client is enabled' do
      before do
    ...
    context 'when accredited_representative_portal_disable_ogc_client is disabled' do
      before do
        allow(Flipper).to receive(:enabled?)
          .with(:accredited_representative_portal_disable_ogc_client)
          .and_return(false)
