...
ActiveRecord::Schema[7.2].define(version: 2026_02_05_231356) do
  ...
  create_table "organization_representatives", force: :cascade do |t|
    ...
    t.string "acceptance_mode", default: "none", null: false
    t.datetime "deactivated_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organization_poa", "representative_id"], name: "idx_org_reps_on_org_poa_and_rep_id", unique: true
    t.check_constraint "acceptance_mode::text = ANY (ARRAY['any_request'::character varying, 'self_only'::character varying, 'none'::character varying]::text[])", name: "org_reps_acceptance_mode_check"
  end
