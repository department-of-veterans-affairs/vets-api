  ...
  describe '#update_poa_access' do
    ...
    context 'happy path' do
      it 'returns an object with the appropriate attributes' do
        VCR.use_cassette('spec/support/vcr_cassettes/claims_api/bgs/corporate_update_web_service/happy_path') do
    ...
    context 'sad path' do
      it 'returns the correct error message when incorrect params are provided' do
        VCR.use_cassette('spec/support/vcr_cassettes/claims_api/bgs/corporate_update_web_service/sad_path') do
