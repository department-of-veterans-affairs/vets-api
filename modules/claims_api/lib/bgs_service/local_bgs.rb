...
module ClaimsApi
  class LocalBGS
    CACHED_SERVICES = %w[ClaimantServiceBean/ClaimantWebService VdcBean/ReadPoaRequest
                         VdcBean/ReadPoaRequestByParticipantId VdcBean/UpdatePoaRequest
                         VdcBean/UpdatePoaRelationship].freeze
