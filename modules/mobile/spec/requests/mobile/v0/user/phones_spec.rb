...
RSpec.describe 'Mobile::V0::User::Phones', type: :request do
  ...
  let(:telephone) { build(:telephone, :contact_info_v2, source_system_user: user.icn, id: 458781, phone_number: 5551235) }
        ...
        VCR.use_cassette('va_profile/v2/contact_information/post_phone_status_complete') do
          VCR.use_cassette('va_profile/v2/contact_information/post_phone_status_incomplete') do
              VCR.use_cassette('va_profile/v2/contact_information/post_telephone_success') do
                post('/mobile/v0/user/phones', params: telephone.to_json,  headers: sis_headers(json: true))
              end
          end
        end
      end
  ...
  describe 'PUT /mobile/v0/user/phones' do
    context 'with a valid phone number' do
      before do
        VCR.use_cassette('va_profile/v2/contact_information/put_phone_status_complete', VCR::MATCH_EVERYTHING) do
          # VCR.use_cassette('va_profile/v2/contact_information/put_phone_status_incomplete', VCR::MATCH_EVERYTHING) do
  ...
  #     before do
  #       telephone.id = 42
  #       VCR.use_cassette('va_profile/v2/contact_information/delete_phone_status_complete', VCR::MATCH_EVERYTHING) do
  #         VCR.use_cassette('va_profile/v2/contact_information/delete_phone_status_incomplete', VCR::MATCH_EVERYTHING) do
