  ...
  context 'when find a rep is enabled' do
    ...
    context 'when searching for a veteran service officer' do
      before do
        ...
        create(:representative, representative_id: '123', poa_codes: %w[A12 A13], user_types: ['veteran_service_officer'], # rubocop:disable Layout/LineLength
                                long: -77.050552, lat: 38.820450, location: 'POINT(-77.050552 38.820450)',
                                first_name: 'Bob', last_name: 'Law') # ~6 miles from Washington, D.C.
        ...
        create(:representative, representative_id: '234', poa_codes: %w[A12 A13], user_types: ['veteran_service_officer'], # rubocop:disable Layout/LineLength
                                long: -77.436649, lat: 39.101481, location: 'POINT(-77.436649 39.101481)',
                                first_name: 'Eliseo', last_name: 'Schroeder') # ~25 miles from Washington, D.C.

        create(:representative, representative_id: '345', poa_codes: %w[A12 A13], user_types: ['veteran_service_officer'], # rubocop:disable Layout/LineLength
                                long: -76.609383, lat: 39.299236, location: 'POINT(-76.609383 39.299236)',
                                first_name: 'Marci', last_name: 'Weissnat') # ~35 miles from Washington, D.C.
