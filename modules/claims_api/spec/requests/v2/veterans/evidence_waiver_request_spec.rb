      ...
      context 'Vet flow' do
        context 'when provided' do
            ...
            context 'when success' do
              it 'returns a 200' do
                mock_ccg(scopes) do |auth_header|
                  VCR.use_cassette('claims_api/bgs/benefit_claim/update_5103_200', erb: true) do
          ...
          context 'when claim id is not found' do
            it 'returns a 404' do
              mock_ccg(scopes) do |auth_header|
                VCR.use_cassette('claims_api/bgs/benefit_claim/find_bnft_claim_400', erb: true) do
                  allow_any_instance_of(ClaimsApi::LocalBGS)
                    .to receive(:find_by_ssn).and_return({ file_nbr: '123456780' })
