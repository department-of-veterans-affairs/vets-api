    ...
    class Individual < ClaimsApi::PoaPdfConstructor::Base
      ...
      def page1_options(data)
        base_form = 'form1[0].#subform[0]'
        {
          ...
          "#{base_form}.Veterans_MailingAddress_NumberAndStreet[0]": get_street_address(data, 'veteran'),
          "#{base_form}.MailingAddress_ApartmentOrUnitNumber[1]": get_unit_or_apartment(data, 'veteran'),
          ...
          "#{base_form}.MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[1]": get_zip_code_first_five(data, 'veteran'),
          "#{base_form}.MailingAddress_ZIPOrPostalCode_ZIPOrPostalCode_LastFourNumbers[1]": get_zip_code_last_four(data, 'veteran'),
          ...
          "#{base_form}.MailingAddress_NumberAndStreet[0]": get_street_address(data, 'claimant'),
          "#{base_form}.MailingAddress_ApartmentOrUnitNumber[0]": get_unit_or_apartment(data, 'claimant'),
          ...
          "#{base_form}.MailingAddress_ZIPOrPostalCode_FirstFiveNumbers[0]": get_zip_code_first_five(data, 'claimant'),
          "#{base_form}.MailingAddress_ZIPOrPostalCode_ZIPOrPostalCode_LastFourNumbers[0]": get_zip_code_last_four(data, 'claimant'),
