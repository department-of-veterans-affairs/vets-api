...
require_relative '../../../../../lib/decision_review/higher_level_review/show/response.rb'
require_relative '../../../../../lib/decision_review/response_schema_error.rb'
require_relative '../../../../../lib/decision_review/schema_error.rb'
require 'rails_helper'

describe DecisionReview::HigherLevelReview::Show::Response do
  let(:response) { Struct.new(:status, :body).new status, body }
  let(:body) { VetsJsonSchema::EXAMPLES["HLR-SHOW-RESPONSE-#{status}"] }
  let(:status) { 200 }
