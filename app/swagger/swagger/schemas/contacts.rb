  ...
  class Contacts
    ...
    swagger_schema :Contacts do
      ...
      property :data, type: :array do
        items do
          property :id, type: %i[string null], example: 'dbbf9a58-41e5-40c0-bdb5-fc1407aa1f05'
    ...
    swagger_schema :Contact do
      ...
      property :contact_type, type: %i[string null], enum: VAProfile::Models::AssociatedPerson::CONTACT_TYPES
