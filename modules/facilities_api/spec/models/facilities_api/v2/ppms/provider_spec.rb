...
RSpec.describe FacilitiesApi::V2::PPMS::Provider, team: :facilities do
  ...
  context 'Creating' do
    it 'defaults to false' do
      provider = FacilitiesApi::V2::PPMS::Provider.new
    ...
    it 'sets the provider_type to GroupPracticeOrAgency' do
      provider = FacilitiesApi::V2::PPMS::Provider.new(provider_type: 'SomeType')
