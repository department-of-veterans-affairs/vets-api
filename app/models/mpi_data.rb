...
class MPIData < Common::RedisStore
  ...
  # @return [User] the user to query MPI for.
  attr_accessor :user

  # Creates a new MPIData instance for a user.
  #
  # @param user [User] the user to query MPI for
  ...
  #
  # @return [MPI::Models::MPIProfile] patient 'golden record' data from MPI
  def profile
  ...
  # The status of the MPI Add Person call. An Orchestrated MPI Search needs to be made before an MPI add person
