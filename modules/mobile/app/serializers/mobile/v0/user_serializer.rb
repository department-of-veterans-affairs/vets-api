      ...
      attribute :profile do |user|
        {
          ...
          home_phone: filter_keys(user.vet360_contact_info&.home_phone, PHONE_KEYS),
          mobile_phone: filter_keys(user.vet360_contact_info&.work_phone, PHONE_KEYS),
          work_phone: filter_keys(user.vet360_contact_info&.mobile_phone, PHONE_KEYS)
        }
      end
