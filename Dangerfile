...
modified_db_files  = all_touched_files.select { |filepath| filepath.include? "spec/" }
modified_app_files = all_touched_files.select { |filepath| filepath.include? "common_service_spec.rb" }
