    ...
    module ProdSupportUtilities
        class Insights
            def count_batches_by_email_grouped(days_ago = 7, gate = 2, form_number = '10-10D')
                ...
                submissions = submissions.map { |r| [r.email, r.unique_submission_count] }.to_h
                ...
                multi_submits = submissions.reject{|key, value| value < gate }
              ...
              def average_time_between_resubmissions(submissions, start_date, end_date, num_of_resubmits, form_number)
                ...
                resubmits = submissions.select{|key, value| value === num_of_resubmits}
                ...
                resubmits.each_key do |email|
                  ...
                  user_batches.each do |batch_uuid, batch|
                    submission = batch[0]
                  ...
                  avg = time_differences.sum / time_differences.size
              ...
              def count_frequency(submitters)
                result_hash = {}
                submitters.each{|_email, num_submissions|
              ...
              def display_frequency(freq_hash)
                ...
                descending.each{|num_submissions, quantity|
              ...
              def display_averages(submissions, start_date, end_date, gate, form_number)
                # Make sure hash is sorted by key:
                descending = submissions.sort_by(&:last).reverse.to_h
              
                unique_nums = descending.values.uniq
              
                unique_nums.each{|num_submissions|
                  next unless num_submissions > 1
              
                  avg_time = average_time_between_resubmissions(submissions, start_date, end_date, num_submissions, form_number)
