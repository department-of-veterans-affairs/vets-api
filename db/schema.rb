...
ActiveRecord::Schema[7.2].define(version: 2026_02_10_181448) do
  ...
  create_table "organization_representatives", force: :cascade do |t|
    ...
    t.check_constraint "acceptance_mode = ANY (ARRAY['any_request'::character varying, 'self_only'::character varying, 'no_acceptance'::character varying])", name: "org_reps_acceptance_mode_check"
  end
