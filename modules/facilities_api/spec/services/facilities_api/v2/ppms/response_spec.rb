...
describe FacilitiesApi::V2::PPMS::Response, team: :facilities do
  ...
  let(:ppms_response) { FacilitiesApi::V2::PPMS::Response.new(response, params) }
  ...
  describe '.initialize' do
    ...
    it 'has a default current_page of 1' do
      expect(FacilitiesApi::V2::PPMS::Response.new(response).current_page).to be(1)
    end
    ...
    it 'has a default per_page of 10' do
      expect(FacilitiesApi::V2::PPMS::Response.new(response).per_page).to be(10)
    end
