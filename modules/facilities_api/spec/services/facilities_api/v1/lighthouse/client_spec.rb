  ...
  let(:vha_358_attributes) do
    {
      ...
      services: { 'health' => %w[Audiology Cardiology Dermatology
                                 MentalHealthCare Ophthalmology SpecialtyCare],
                  'last_updated' => '2022-01-16', 'other' => [] },
      feedback: {
      ...
      access: {
        ...
        'health' => [
          { service: 'Audiology',       new: 27.923076, established: 31.757575 },
          { service: 'Cardiology',      new: 68.571428, established: 38.59375  },
          { service: 'Dermatology',     new: 58.0,      established: 79.454545 },
          { service: 'MentalHealthCare', new: 33.714285, established: 35.794117 },
          { service: 'Ophthalmology',   new: 103.0,     established: 49.111111 },
          { service: 'SpecialtyCare',   new: 69.174603, established: 14.536791 }
        ]
      },
      mobile: false,
      active_status: 'A',
