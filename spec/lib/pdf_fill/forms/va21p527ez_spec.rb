    ...
    it 'should merge the right fields' do
      expect(described_class.new(form_data).merge_fields).to eq(
        {"veteranFullName"=>"john middle smith Sr.",
         ...
         "otherMarriage" => "other marriage",
         "spouseMarriageCount" => 2,
         "spouseMarriages" => [{}, {}],
         "activeServiceDateRangeEnd" => "2013-04-10",
         "outsideChildren" => [{"childAddress"=>"str1, city1, MD, 21231, USA", "childFullName"=>"outside1 Olson", "childNotInHousehold"=>true, "personWhoLivesWithChild"=>"person1 Olson", "monthlyPayment"=>1}, {"childAddress"=>"str2, city1, MD, 21231, USA", "childFullName"=>"outside2 Olson", "personWhoLivesWithChild"=>"person2 Olson", "childNotInHousehold"=>true, "monthlyPayment"=>2}, {"childAddress"=>"str3, city1, MD, 21231, USA", "childFullName"=>"outside3 Olson", "personWhoLivesWithChild"=>"person3 Olson", "childNotInHousehold"=>true, "monthlyPayment"=>3}],
         ...
         "spouseOtherMarriage" => "spouse other marriage",
         ...
         "spouseMarriages" => [{"spouseFullName"=>"spouse1 Olson", "dateOfMarriage"=>"1985-03-01", "locationOfMarriage"=>"marriagelocation1", "locationOfSeparation"=>"location1", "marriageType"=>"type1", "dateOfSeparation"=>"1985-04-01", "reasonForSeparation"=>"divorce1"}, {"spouseFullName"=>"spouse2 Olson", "dateOfMarriage"=>"1985-03-02", "dateOfSeparation"=>"1985-04-02", "locationOfMarriage"=>"marriagelocation2", "locationOfSeparation"=>"location2", "marriageType"=>"type2", "reasonForSeparation"=>"divorce2"}],
         "marriages" => [{"spouseFullName"=>"Mark1 Olson", "dateOfMarriage"=>"1985-03-01", "dateOfSeparation"=>"1985-04-01", "locationOfMarriage"=>"marriagelocation1", "locationOfSeparation"=>"location1", "marriageType"=>"type1", "reasonForSeparation"=>"divorce1"}, {"spouseFullName"=>"Mark2 Olson", "dateOfMarriage"=>"1985-03-02", "dateOfSeparation"=>"1985-04-02", "locationOfMarriage"=>"marriagelocation2", "locationOfSeparation"=>"location2", "marriageType"=>"type2", "reasonForSeparation"=>"divorce2"}],
         "children" => [{"childFullName"=>"Mark1 Olson", "childPlaceOfBirth"=>"place1", "attendingCollege"=>true, "married"=>true, "biological"=>true, "stepchild"=>true, "disabled"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil, "childAddress"=>nil}, {"childFullName"=>"Mark2 Olson", "childPlaceOfBirth"=>"place2", "attendingCollege"=>true, "married"=>true, "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil, "childAddress"=>nil}, {"childFullName"=>"Mark3 Olson", "childPlaceOfBirth"=>"place3", "attendingCollege"=>true, "married"=>true, "disabled"=>true, "biological"=>true, "stepchild"=>true, "adopted"=>true, "previouslyMarried"=>true, "personWhoLivesWithChild"=>nil, "childAddress"=>nil}],
         "genderMale"=>true,
         "genderFemale"=>false,
