  ...
  describe '#show' do
    context 'happy path' do
        ...
        VCR.use_cassette('travel_pay/show/success_details', match_requests_on: %i[method path]) do
          claim_id = '16cbc3d0-56de-4d86-abf3-ed0f6908ee53'

          get("/mobile/v0/travel-pay/claims/#{claim_id}", headers: sis_headers, params: { id: claim_id })
    ...
    context 'failure paths' do
      it 'returns not found when claim does not exist' do
        ...
        non_existent_claim_id = 'aa0f63e0-5fa7-4d74-a17a-a6f510dbf69e'
