...
RSpec.describe InProgressForms::V0::InProgressFormsController do
  # TODO:
  ...
  context 'with a user' do
    ...
    describe '#index' do
      subject do
        get "/in_progress_forms/v0/in_progress_forms", params: nil
      end
      ...
      context 'when the user is not loa3' do
        ...
        context 'with OliveBranch' do
          subject do
            get(
              "/in_progress_forms/v0/in_progress_forms",
    ...
    describe '#show' do
      ...
      context 'when the user is not loa3' do
        ...
        it 'returns a 200' do
          get "/in_progress_forms/v0/in_progress_forms/#{in_progress_form.form_id}", params: nil
          expect(response).to have_http_status(:ok)
        end
      end
      ...
      context 'when a form is found' do
        ...
        context 'with the x key inflection header set' do
          it 'converts the json keys' do
            ...
            get "/in_progress_forms/v0/in_progress_forms/#{in_progress_form.form_id}",
      ...
      context 'when a form is not found' do
        ...
        it 'returns pre-fill data' do
          expected_data
          get "/in_progress_forms/v0/in_progress_forms/FAKEFORM", params: nil
        ...
        it 'returns pre-fill data the same way, with or without the Inflection heaader' do
          ...
          get "/in_progress_forms/v0/in_progress_forms/FAKEFORM"
      ...
      context 'when a form mapping is not found' do
        it 'returns a 500' do
          ...
          get "/in_progress_forms/v0/in_progress_forms/foo", params: nil
    ...
    describe '#update' do
      ...
      context 'with a new form' do
        ...
        context 'when the user is not loa3' do
          ...
          it 'returns a 200 with camelCases JSON' do
            put "/in_progress_forms/v0/in_progress_forms/#{new_form.form_id}", params: {
        ...
        it 'can have nil metadata' do
          put "/in_progress_forms/v0/in_progress_forms/#{new_form.form_id}",
        ...
        context 'when an error occurs' do
          it 'returns an error response' do
            ...
            put "/in_progress_forms/v0/in_progress_forms/#{new_form.form_id}", params: { form_data: new_form.form_data }
            expect(response).to have_http_status(:internal_server_error)
      ...
      context 'with an existing form' do
        ...
        it 'updates the right form' do
          put "/in_progress_forms/v0/in_progress_forms/#{existing_form.form_id}", params: { form_data: }
          expect(response).to have_http_status(:ok)
        ...
        context 'has checked \'One or more of my rated conditions that have gotten worse\'' do
          ...
          context 'has no ratings with maximum_rating_percentage' do
            it 'updates form with cfiMetric metadata but does not call StatsD' do
              put "/in_progress_forms/v0/in_progress_forms/#{existing_form.form_id}",
    ...
    describe '#destroy' do
      ...
      context 'when the user is not loa3' do
        ...
        it 'returns a 200 with camelCase JSON' do
          delete "/in_progress_forms/v0/in_progress_forms/#{in_progress_form.form_id}", params: nil
          expect(response).to have_http_status(:ok)
          expect(JSON.parse(response.body)['data']['attributes'].keys)
            .to contain_exactly('formId', 'createdAt', 'updatedAt', 'metadata')
        end
      ...
      context 'when a form is not found' do
        subject do
          delete "/in_progress_forms/v0/in_progress_forms/ksdjfkjdf", params: nil
        end
  ...
  context 'without a user' do
    describe '#show' do
      ...
      it 'says hello' do
        get "/in_progress_forms/v0/hello", params: nil
      end
