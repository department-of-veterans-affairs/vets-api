          ...
          property :data, type: :object do
            ...
            property :attributes, type: :object do
              property :vet360_contact_information, type: :object do
                ...
                [
                  [:residential_address, ::Vet360::Models::Address::RESIDENCE],
                  [:mailing_address, ::Vet360::Models::Address::CORRESPONDENCE]
                ].each do |address_fields|
                  property address_fields[0], type: :object do
                    ...
                    property :address_pou, type: :string, example: address_fields[1]
