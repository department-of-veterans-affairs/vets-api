...
1.	Create a Gateway to fetch status from your Form API inheriting from `BaseGateway`:
...
3.	Create a Formatter for your API data inheriting from `BaseFormatter`:
...
```
5. Add your gateway to the `Report` class:
...
6. Update/add tests and test locally to confirm the status card displays correctly.
7. Test locally to confirm the form status card appears
8. Run the submission statuses specs to ensure your implementation works:
