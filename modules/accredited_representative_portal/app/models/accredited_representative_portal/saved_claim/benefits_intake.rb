  ...
  module SavedClaim
    class BenefitsIntake < ::SavedClaim
      ...
      with_options(attachment_association_options) do
        has_one(
          :form_attachment,
          -> { where(type: 'AccreditedRepresentativePortal::PersistentAttachments::VAForm') },
        ...
        has_many(
          ...
          -> { where(type: 'AccreditedRepresentativePortal::PersistentAttachments::VAFormDocumentation') }
        )
      end
