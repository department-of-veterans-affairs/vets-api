...
RSpec.describe VeteranVerification::Notary do
  let (:keypair_path) { "#{VeteranVerification::Engine.root}/spec/fixtures/verification_test.pem" }
  ...
  it 'throws a helpful exception if no key exists to encode payloads', focus: true do
