  ...
  describe '.saml_settings' do
    context 'with a 200 response' do
      ...
      it 'returns a settings instance' do
        expect(SAML::SettingsService.saml_settings).to be_an_instance_of(OneLogin::RubySaml::Settings)
      end
    end
    ...
    context 'when a parsing error occurs' do
      it 'should log and reraise the error' do
        ...
        expect { SAML::SettingsService.saml_settings }.to raise_error(REXML::ParseException)
      end
    end
  end
end
