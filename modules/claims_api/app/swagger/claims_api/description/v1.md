...
If you are filing an original claim, and the filer is **not** the veteran (the oauth token is not the veteran’s), see the [PUT endpoint](#operations-Disability-upload526Attachment).
