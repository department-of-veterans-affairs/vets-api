        ...
        class Service < MebApi::DGI::Service
          ...
          def update_dd_params(params, dd_params)
            ...
            if check_masking && !Flipper.enabled?(:toe_light_house_dgi_direct_deposit, @current_user)
              ...
              params[:form][:direct_deposit][:account_number] = dd_params&.payment_account[:account_number]
              params[:form][:direct_deposit][:routing_number] = dd_params&.payment_account[:routing_number]
            end
            params
          end
