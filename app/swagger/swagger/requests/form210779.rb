    ...
    class Form210779
      ...
      swagger_path '/v0/form21_0779' do
        operation :post do
          ...
          key :description, 'Submit a 21-0779 form (Request for Nursing Home Information in Connection with Claim for Aid and Attendance)'
          ...
          parameter do
            ...
            schema do
              ...
              property :generalInformation do
                key :type, :object
                key :required, %i[admissionDate medicaidFacility medicaidApplication patientMedicaidCovered certificationLevelOfCare nursingOfficialName nursingOfficialTitle nursingOfficialPhoneNumber]
