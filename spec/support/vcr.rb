...
VCR.configure do |c|
  ...
  c.filter_sensitive_data('<TRAVEL_PAY_V2_BASE_URL>') { Settings.travel_pay.documents.v2.base_url }
  c.filter_sensitive_data('<TRAVEL_PAY_V3_BASE_URL>') { Settings.travel_pay.documents.v3.base_url }
