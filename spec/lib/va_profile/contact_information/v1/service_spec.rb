...
describe VAProfile::ContactInformation::V1::Service, :skip_vet360 do
  ...
  describe '#get_person' do
    context 'when successful' do
      ...
      it 'supports international provinces' do
        VCR.use_cassette('va_profile/contact_information/v1/person_intl_addr', VCR::MATCH_EVERYTHING) do
          response = subject.get_person
    ...
    context 'when not successful' do
      ...
      context 'with a 400 error' do
        it 'returns nil person' do
          VCR.use_cassette('va_profile/contact_information/v1/person_error_400', VCR::MATCH_EVERYTHING) do
            response = subject.get_person
    ...
    context 'when service returns a 503 error code' do
      it 'raises a BackendServiceException error' do
        VCR.use_cassette('va_profile/contact_information/v1/person_status_503', VCR::MATCH_EVERYTHING) do
    ...
    context 'when person response has no body data' do
      it 'returns 200' do
        VCR.use_cassette('va_profile/contact_information/v1/person_without_data', VCR::MATCH_EVERYTHING) do
          response = subject.get_person
          expect(response).to be_ok
          expect(response.person).to be_a(VAProfile::Models::Person)
        end
  ...
  describe '#post_email' do
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/post_email_success', VCR::MATCH_EVERYTHING) do
    ...
    context 'when an ID is included' do
      it 'raises an exception' do
        VCR.use_cassette('va_profile/contact_information/v1/post_email_w_id_error', VCR::MATCH_EVERYTHING) do
          email.id = 42
          email.email_address = 'person42@example.com'
  ...
  describe '#put_email' do
    ...
    context 'when successful' do
      it 'creates an old_email record' do
        VCR.use_cassette('va_profile/contact_information/v1/put_email_success', VCR::MATCH_EVERYTHING) do
          VCR.use_cassette('va_profile/contact_information/v1/person_full', VCR::MATCH_EVERYTHING) do
  ...
  describe '#post_address' do
    ...
    context 'when an ID is included' do
      it 'raises an exception' do
        VCR.use_cassette('va_profile/contact_information/v1/post_address_w_id_error', VCR::MATCH_EVERYTHING) do
          address.id = 42
          address.address_line1 = '1493 Martin Luther King Rd'
          address.city = 'Fulton'
          address.state_code = 'MS'
  ...
  describe '#put_address' do
    ...
    context 'with a validation key' do
      ...
      it 'overrides the address error', run_at: '2020-02-14T00:19:15.000Z' do
        VCR.use_cassette(
          'va_profile/contact_information/v1/put_address_override',
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/put_address_success', VCR::MATCH_EVERYTHING) do
          address.id = 15_035
  ...
  describe '#put_telephone' do
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/put_telephone_success', VCR::MATCH_EVERYTHING) do
          telephone.id = 17_259
  ...
  describe '#post_telephone' do
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/post_telephone_success', VCR::MATCH_EVERYTHING) do
    ...
    context 'when an ID is included' do
      it 'raises an exception' do
        VCR.use_cassette('va_profile/contact_information/v1/post_telephone_w_id_error', VCR::MATCH_EVERYTHING) do
          telephone.id = 42
  ...
  describe '#put_permission' do
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/put_permission_success', VCR::MATCH_EVERYTHING) do
          permission.id = 401
  ...
  describe '#post_permission' do
    ...
    context 'when successful' do
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/post_permission_success', VCR::MATCH_EVERYTHING) do
    ...
    context 'when an ID is included' do
      it 'raises an exception' do
        VCR.use_cassette('va_profile/contact_information/v1/post_permission_w_id_error', VCR::MATCH_EVERYTHING) do
          permission.id = 401
  ...
  describe '#get_telephone_transaction_status' do
    context 'when successful' do
      ...
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/telephone_transaction_status', VCR::MATCH_EVERYTHING) do
    ...
    context 'when not successful' do
      ...
      it 'returns a status of 404' do
        VCR.use_cassette('va_profile/contact_information/v1/telephone_transaction_status_error', VCR::MATCH_EVERYTHING) do
  ...
  describe '#get_email_transaction_status' do
    ...
    context 'when not successful' do
      ...
      it 'returns a status of 404' do
        VCR.use_cassette('va_profile/contact_information/v1/email_transaction_status_error', VCR::MATCH_EVERYTHING) do
  ...
  context 'update model methods' do
    before do
      VCR.insert_cassette('va_profile/contact_information/v1/person_full', VCR::MATCH_EVERYTHING)
      allow(VAProfile::Configuration::SETTINGS.contact_information).to receive(:cache_enabled).and_return(true)
    end
        ...
        context "when the #{spec_data[:model_name]} doesnt exist" do
          ...
          it 'makes a post request' do
            expect_any_instance_of(
              VAProfile::ContactInformation::V1::Service
  ...
  describe '#get_address_transaction_status' do
    context 'when successful' do
      ...
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/address_transaction_status', VCR::MATCH_EVERYTHING) do
          expect_any_instance_of(described_class).to receive(:send_contact_change_notification)
    ...
    context 'when not successful' do
      ...
      it 'returns a status of 404' do
        VCR.use_cassette('va_profile/contact_information/v1/address_transaction_status_error', VCR::MATCH_EVERYTHING) do
      ...
      it 'logs the failure to pii logs' do
        ...
        VCR.use_cassette(
          'va_profile/contact_information/v1/address_transaction_addr_not_found',
          VCR::MATCH_EVERYTHING
        ) do
          ...
          expect(personal_information_log.error_class).to eq(
            'VAProfile::ContactInformation::V1::AddressTransactionResponseError'
          )
  ...
  describe '#get_permission_transaction_status' do
    context 'when successful' do
      ...
      it 'returns a status of 200' do
        VCR.use_cassette('va_profile/contact_information/v1/permission_transaction_status', VCR::MATCH_EVERYTHING) do
    ...
    context 'when not successful' do
      ...
      it 'returns a status of 400' do
        VCR.use_cassette('va_profile/contact_information/v1/permission_transaction_status_error', VCR::MATCH_EVERYTHING) do
  ...
  describe '#get_person_transaction_status' do
    context 'when successful' do
      ...
      it 'returns a status of 200', :aggregate_failures do
        VCR.use_cassette('va_profile/contact_information/v1/person_transaction_status', VCR::MATCH_EVERYTHING) do
    ...
    context 'when checking transaction status' do
      ...
      context 'for telephones' do
        it 'increments the StatsD VAProfile posts_and_puts counters' do
          ...
          VCR.use_cassette('va_profile/contact_information/v1/telephone_transaction_status') do
            expect_any_instance_of(described_class).to receive(:send_contact_change_notification)
