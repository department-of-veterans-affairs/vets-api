...
module MHVLogging
  class Service
    def self.login(current_user)
      ...
      return if current_user.mhv_last_signed_in || current_user.mhv_correlation_id.nil?
    ...
    def self.logout(current_user)
      ...
      return unless current_user.mhv_last_signed_in || current_user.mhv_correlation_id.nil?
